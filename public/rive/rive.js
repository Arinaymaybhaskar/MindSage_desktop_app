(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === "object") exports["rive"] = factory();
  else root["rive"] = factory();
})(this, () => {
  return /******/ (() => {
    // webpackBootstrap
    /******/ "use strict";
    /******/ var __webpack_modules__ = [
      ...
      /***/ (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ Animation: () =>
            /* reexport safe */ _Animation__WEBPACK_IMPORTED_MODULE_0__.Animation,
          /* harmony export */
        });
        /* harmony import */ var _Animation__WEBPACK_IMPORTED_MODULE_0__ =
      ...
      /***/ (
        ...
        var Animation = /** @class */ (function () {
          ...
          function Animation(animation, artboard, runtime, playing) {
             ...
             */
            this.scrubTo = null;
            this.instance = new runtime.LinearAnimationInstance(
              animation,
              artboard,
            );
          }
      ...
      /***/ (
        ...
        /* harmony import */ var _rive_advanced_mjs__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(4);
        /* harmony import */ var package_json__WEBPACK_IMPORTED_MODULE_1__ =
        ...
        var RuntimeLoader = /** @class */ (function () {
          ...
          RuntimeLoader.notifyError = function (error) {
            ...
            while (RuntimeLoader.errorCallbackQueue.length > 0) {
              (_a = RuntimeLoader.errorCallbackQueue.shift()) === null ||
              _a === void 0
                ? void 0
                : _a(error);
            }
            ...
            _rive_advanced_mjs__WEBPACK_IMPORTED_MODULE_0__["default"](
              ...
              .then(function (rive) {
                ...
                while (RuntimeLoader.callBackQueue.length > 0) {
                  (_a = RuntimeLoader.callBackQueue.shift()) === null ||
                  _a === void 0
                    ? void 0
                    : _a(RuntimeLoader.runtime);
                }
              })
                ...
                if (fallbackUrl !== null && !alreadyOnFallback) {
                  console.warn(
                    "Failed to load WASM from "
                      .concat(attemptedUrl, " (")
                      .concat(errorDetails.message, "), trying fallback URL: ")
                      .concat(fallbackUrl),
                  );
                  ...
                  var triedUrls = alreadyOnFallback
                    ? "the configured WASM URL or its fallback (".concat(
                        fallbackUrl,
                        ")",
                      )
                    : attemptedUrl;
          ...
          RuntimeLoader.wasmFallbackURL = "https://cdn.jsdelivr.net/npm/"
            .concat(package_json__WEBPACK_IMPORTED_MODULE_1__.name, "@")
            .concat(
              package_json__WEBPACK_IMPORTED_MODULE_1__.version,
              "/rive_fallback.wasm",
      ...
      /***/ (
        ...
        var Rive = (() => {
          ...
          return async function (moduleArg = {}) {
            var moduleRtn;
            var k = moduleArg,
              ca = !!globalThis.window,
              da = !!globalThis.WorkerGlobalScope;
            function ea() {
              function a(g) {
                const h = d;
                c = b = 0;
                ...
                b.set(
                  ...
                  setTimeout(function () {
                    ...
                    0 == b.length
                      ? (c = -Infinity)
                      : d == c &&
                        ((c = Math.max(...b.keys())), console.assert(c < d));
                  }, 1e3),
                );
                c = Math.max(d, c);
                return c << a;
            ...
            k.onRuntimeInitialized = function () {
              ...
              k.FallbackFileAssetLoader = d.extend("FallbackFileAssetLoader", {
                ...
                loadContents: function (f, g) {
                  for (let h of this.hc) if (h.loadContents(f, g)) return !0;
                  return !1;
                },
              });
              let e = k.computeAlignment;
              k.computeAlignment = function (f, g, h, m, l = 1) {
            ...
            const ia =
              ...
              ja = new (function () {
                function a() {
                  if (!b) {
                    ...
                    if (/iPhone|iPad|iPod/i.test(navigator.userAgent)) {
                      if (((p = w.getContext("webgl", x)), (c = 1), !p))
                        return (
                          console.log(
                    ...
                    } else if ((p = w.getContext("webgl2", x))) c = 2;
                    else if ((p = w.getContext("webgl", x))) c = 1;
                    else
                      return (
                        console.log(
                          "No WebGL support. Image mesh will not be drawn.",
                    ...
                    p = new Proxy(p, {
                      get(F, q) {
                        if (F.isContextLost()) {
                          ...
                          return "function" === typeof F[q]
                            ? function (...K) {
                                return F[q].apply(F, K);
                              }
                            : F[q];
                      },
                      set(F, q, K) {
                    ...
                    d = Math.min(
                      p.getParameter(p.MAX_RENDERBUFFER_SIZE),
                    ...
                    function H(F, q, K) {
                      ...
                      p.shaderSource(q, K);
                      p.compileShader(q);
                      K = p.getShaderInfoLog(q);
                      if (0 < (K || "").length) throw K;
                      p.attachShader(F, q);
                    }
                    w = p.createProgram();
                    H(
                    ...
                    p.bindAttribLocation(w, 0, "vertex");
                    p.bindAttribLocation(w, 1, "uv");
                    p.linkProgram(w);
                    x = p.getProgramInfoLog(w);
                    if (0 < (x || "").trim().length) throw x;
                    e = p.getUniformLocation(w, "mat");
                    f = p.getUniformLocation(w, "translate");
                    p.useProgram(w);
                    ...
                    p.uniform1i(p.getUniformLocation(w, "image"), 0);
                ...
                this.Ic = function (w) {
                  b.deleteTexture && b.deleteTexture(w);
                };
                this.Hc = function (w) {
                  if (!a()) return null;
                  const x = b.createTexture();
                  if (!x) return null;
                  b.bindTexture(b.TEXTURE_2D, x);
                  b.texImage2D(
                    b.TEXTURE_2D,
                    0,
                    b.RGBA,
                ...
                const l = new fa(8),
                  ...
                  y = new fa(10),
                  t = new fa(10);
                this.Lc = function (w, x, p, H, F) {
                  if (a()) {
                    var q = l.push(w),
                      K = u.push(x);
                    if (b.canvas) {
                      if (b.canvas.width != q || b.canvas.height != K)
                        ((b.canvas.width = q), (b.canvas.height = K));
                      b.viewport(0, K - x, w, x);
                      b.disable(b.SCISSOR_TEST);
                      b.clearColor(0, 0, 0, 0);
                      b.clear(b.COLOR_BUFFER_BIT);
                      b.enable(b.SCISSOR_TEST);
                      p.sort((I, Z) => Z.tc - I.tc);
                      q = y.push(H);
                      g != q &&
                        (b.bufferData(b.ARRAY_BUFFER, 8 * q, b.DYNAMIC_DRAW),
                        (g = q));
                      q = 0;
                      for (var O of p)
                        (b.bufferSubData(b.ARRAY_BUFFER, q, O.Tb),
                          (q += 4 * O.Tb.length));
                      console.assert(q == 4 * H);
                      for (var S of p)
                        (b.bufferSubData(b.ARRAY_BUFFER, q, S.xc),
                          (q += 4 * S.xc.length));
                      console.assert(q == 8 * H);
                      q = t.push(F);
                      h != q &&
                        (b.bufferData(
                      ...
                      O = 0;
                      for (var na of p)
                        (b.bufferSubData(b.ELEMENT_ARRAY_BUFFER, O, na.indices),
                          (O += 2 * na.indices.length));
                      console.assert(O == 2 * F);
                      na = 0;
                      S = !0;
                      q = O = 0;
                      for (const I of p) {
                        I.image.Ib != na &&
                          (b.bindTexture(b.TEXTURE_2D, I.image.Hb || null),
                          (na = I.image.Ib));
                        I.ed
                          ? (b.scissor(I.Yb, K - I.Zb - I.fc, I.od, I.fc),
                            (S = !0))
                          : S && (b.scissor(0, K - x, w, x), (S = !1));
                        p = 2 / w;
                        const Z = -2 / x;
                        b.uniform4f(
                          e,
                        ...
                        b.uniform2f(
                          f,
                          I.ib[4] * p * I.Ab + p * (I.Yb - I.bd * I.Ab) - 1,
                          I.ib[5] * Z * I.Bb + Z * (I.Zb - I.cd * I.Bb) + 1,
                        );
                        b.vertexAttribPointer(0, 2, b.FLOAT, !1, 0, q);
                        b.vertexAttribPointer(1, 2, b.FLOAT, !1, 0, q + 4 * H);
                        b.drawElements(
                          b.TRIANGLES,
                          I.indices.length,
                          b.UNSIGNED_SHORT,
            ...
            k.onRuntimeInitialized = function () {
              ...
              function c() {
                0 < K.length &&
                  (ja.Lc(q.drawWidth(), q.drawHeight(), K, O, S),
                  (K = []),
                  (S = O = 0),
                  q.reset(512, 512));
                for (const n of F) {
                  for (const r of n.Na) r();
                  n.Na = [];
                }
                F.clear();
              }
              ...
              const e = k.RenderPath,
                ...
                u = d.fill,
                y = d.stroke,
                t = k.FillRule.evenOdd;
              let w = 1;
              var x = k.RenderImage.extend("CanvasRenderImage", {
                  __construct: function ({ ob: n, yb: r } = {}) {
                    this.__parent.__construct.call(this);
                    this.Ib = w;
                    w = (w + 1) & 2147483647 || 1;
                    this.ob = n;
                  ...
                  __destruct: function () {
                    this.Hb && (ja.Ic(this.Hb), URL.revokeObjectURL(this.Wb));
                  ...
                  decode: function (n) {
                    ...
                    r.yb && r.yb(r);
                    var G = new Image();
                    r.Wb = URL.createObjectURL(
                      new Blob([n], { type: "image/png" }),
                    );
                    G.onload = function () {
                      r.Ac = G;
                      r.Hb = ja.Hc(G);
                ...
                p = e.extend("CanvasRenderPath", {
                  ...
                  addPath: function (n, r, G, D, z, E, C) {
                    var L = this.Ya,
                      ua = L.addPath;
                    n = n.Ya;
                  ...
                  cubicTo: function (n, r, G, D, z, E) {
                    this.Ya.bezierCurveTo(n, r, G, D, z, E);
                  },
                  close: function () {
                    this.Ya.closePath();
                  },
                ...
                H = f.extend("CanvasRenderPaint", {
                  ...
                  linearGradient: function (n, r, G, D) {
                    this.lb = { uc: n, vc: r, bc: G, cc: D, Sb: [] };
                  },
                  radialGradient: function (n, r, G, D) {
                    this.lb = { uc: n, vc: r, bc: G, cc: D, Sb: [], Zc: !0 };
                  },
                  addStop: function (n, r) {
                    this.lb.Sb.push({ color: n, stop: r });
                  },
                  completeGradient: function () {},
                  draw: function (n, r, G, D) {
                    let z = this.Dc;
                    var E = this.Xb,
                      C = this.lb;
                    const L = n.globalCompositeOperation,
                      ua = n.globalAlpha;
                    n.globalCompositeOperation = this.zc;
                    n.globalAlpha = D;
                    if (null != C) {
                      E = C.uc;
                      const V = C.vc,
                      ...
                      C.Zc
                        ...
                        : (E = n.createLinearGradient(E, V, ba, R));
                      for (let W = 0, aa = D.length; W < aa; W++)
                        ((C = D[W]), E.addColorStop(C.stop, b(C.color)));
                      this.Xb = E;
                      this.lb = null;
                    }
                    switch (z) {
                      case y:
                        ...
                        break;
                      case u:
                        ((n.fillStyle = E), n.fill(r, G));
                    }
                    n.globalCompositeOperation = L;
                    n.globalAlpha = ua;
                  },
                });
              const F = new Set();
              let q = null,
                ...
                O = 0,
                S = 0;
              var na = (k.CanvasRenderer = g.extend("Renderer", {
                ...
                restore: function () {
                  const n = this.Xa.length - 6;
                  if (6 > n) throw "restore() called without matching save().";
                  this.Xa.splice(n);
                  this.Ka.pop();
                  this.Na.push(this.Ha.restore.bind(this.Ha));
                },
                transform: function (n, r, G, D, z, E) {
                  const C = this.Xa,
                    L = C.length - 6;
                  C.splice(
                    L,
                    ...
                    C[L + 1] * G + C[L + 3] * D,
                    C[L] * z + C[L + 2] * E + C[L + 4],
                    C[L + 1] * z + C[L + 3] * E + C[L + 5],
                  );
                  this.Na.push(
                    this.Ha.transform.bind(this.Ha, n, r, G, D, z, E),
                  );
                },
                rotate: function (n) {
                  const r = Math.sin(n);
                ...
                _drawPath: function (n, r) {
                  this.Na.push(
                    r.draw.bind(
                      ...
                      this.Ha,
                      n.Ya,
                      n.Vb === t ? "evenodd" : "nonzero",
                      Math.max(0, this.Ka[this.Ka.length - 1]),
                    ),
                  );
                },
                _drawRiveImage: function (n, r, G, D) {
                  var z = n.Ac;
                  if (z) {
                    var E = this.Ha,
                      C = a(G),
                      L = Math.max(0, D * this.Ka[this.Ka.length - 1]);
                ...
                _drawImageMesh: function (
                  ...
                  let Qb, Rb, Sb;
                  try {
                    ((Qb = k.HEAPF32.slice(z >> 2, (z >> 2) + E)),
                      (Rb = k.HEAPF32.slice(C >> 2, (C >> 2) + L)),
                      (Sb = k.HEAPU16.slice(ua >> 1, (ua >> 1) + R)));
                  } catch (hb) {
                    console.error(
                  ...
                  r = this.Ha.canvas.width;
                  z = this.Ha.canvas.height;
                  C = W - V;
                  L = aa - ba;
                  V = Math.max(V, 0);
                  ba = Math.max(ba, 0);
                  ...
                  const Da = W - V,
                    Ea = aa - ba;
                  console.assert(Da <= Math.min(C, r));
                  console.assert(Ea <= Math.min(L, z));
                  if (!(0 >= Da || 0 >= Ea)) {
                    W = Da < C || Ea < L;
                    r = aa = 1;
                    var oa = Math.ceil(Da * aa),
                      pa = Math.ceil(Ea * r);
                    z = ja.ad();
                    oa > z && ((aa *= z / oa), (oa = z));
                    pa > z && ((r *= z / pa), (pa = z));
                    q || ((q = new k.DynamicRectanizer(z)), q.reset(512, 512));
                    z = q.addRect(oa, pa);
                    0 > z &&
                      (c(),
                      F.add(this),
                    ...
                    var va = this.Ha,
                      Vc = a(G),
                      Wc = Math.max(0, D * this.Ka[this.Ka.length - 1]);
                    this.Na.push(function () {
                      va.save();
                      va.resetTransform();
                      va.globalCompositeOperation = Vc;
                      va.globalAlpha = Wc;
                      const hb = ja.canvas();
                      hb && va.drawImage(hb, Tb, Ub, oa, pa, V, ba, Da, Ea);
                      va.restore();
                    });
                  }
                },
              ...
              let I = k.load,
                Z = null;
              k.load = function (n, r, G = !0) {
                const D = new k.FallbackFileAssetLoader();
                void 0 !== r && D.addLoader(r);
                G && ((r = new k.CDNFileAssetLoader()), D.addLoader(r));
              ...
              let Xc = k.RendererWrapper.prototype.align;
              k.RendererWrapper.prototype.align = function (n, r, G, D, z = 1) {
                Xc.call(this, n, r, G, D, z);
              };
              d = new ea();
              k.requestAnimationFrame = d.requestAnimationFrame.bind(d);
              k.cancelAnimationFrame = d.cancelAnimationFrame.bind(d);
              k.enableFPSCounter = d.Mc.bind(d);
              k.disableFPSCounter = d.Jc;
              d.mc = c;
            ...
            var la = "./this.program";
            da && (_scriptName = self.location.href);
            var ma = "",
              qa,
              ra;
            if (ca || da) {
            ...
            function La() {
              ...
              k.HEAPU16 = Fa = new Uint16Array(a);
              k.HEAP32 = B = new Int32Array(a);
              k.HEAPU32 = J = new Uint32Array(a);
              k.HEAPF32 = Ga = new Float32Array(a);
              Ha = new Float64Array(a);
              Ia = new BigInt64Array(a);
              Ja = new BigUint64Array(a);
            }
            function Na(a) {
              k.onAbort?.(a);
              a = "Aborted(" + a + ")";
            ...
            async function Pa(a) {
              ...
              if (a == Oa && xa) a = new Uint8Array(xa);
              else if (ra) a = ra(a);
            ...
            async function Qa(a, b) {
              try {
                ...
                (wa(`failed to asynchronously prepare wasm: ${d}`), Na(d));
              }
            }
            async function Ra(a) {
              var b = Oa;
              if (!xa && !sa(b))
                try {
                  ...
                  (wa(`wasm streaming compile failed: ${d}`),
            ...
            var Ta = (a) => {
              ...
              fb = globalThis.TextDecoder && new TextDecoder(),
              gb = (a, b, c, d) => {
                c = b + c;
                if (d) return c;
                for (; a[b] && !(b >= c);) ++b;
            ...
            var pb = {
                ...
                read(a, b, c, d) {
                  if (!a.Ca || !a.Ca.ab.ec) throw new M(60);
                  for (var e = 0, f = 0; f < d; f++) {
                    try {
                      var g = a.Ca.ab.ec(a.Ca);
                    } catch (h) {
                      throw new M(29);
                    }
                  ...
                  e && (a.node.gb = Date.now());
                  return e;
                },
                write(a, b, c, d) {
                  if (!a.Ca || !a.Ca.ab.Pb) throw new M(60);
                  try {
                    for (var e = 0; e < d; e++) a.Ca.ab.Pb(a.Ca, b[c + e]);
                  } catch (f) {
                    throw new M(29);
                  }
                  d && (a.node.Ra = a.node.Oa = Date.now());
                  return e;
                },
              },
              qb = {
                ...
                Pb(a, b) {
                  null === b || 10 === b
                    ? (ta(ib(a.output)), (a.output = []))
                    : 0 != b && a.output.push(b);
                },
                sb(a) {
                  0 < a.output?.length && (ta(ib(a.output)), (a.output = []));
                },
                Wc() {
                  return {
                    xd: 25856,
              ...
              rb = {
                Pb(a, b) {
                  null === b || 10 === b
                    ? (wa(ib(a.output)), (a.output = []))
                    : 0 != b && a.output.push(b);
                },
                sb(a) {
                  0 < a.output?.length && (wa(ib(a.output)), (a.output = []));
                },
              },
              N = {
                Ua: null,
                ...
                createNode(a, b, c, d) {
                  ...
                  N.Ua ||
                    (N.Ua = {
                      ...
                      link: {
                        node: { eb: N.za.eb, Wa: N.za.Wa, pb: N.za.pb },
                        stream: {},
                      },
                      $b: { node: { eb: N.za.eb, Wa: N.za.Wa }, stream: sb },
                    });
                  c = tb(a, b, c, d);
                  16384 === (c.mode & 61440)
                    ? ((c.za = N.Ua.dir.node),
                      (c.xa = N.Ua.dir.stream),
                      (c.ya = {}))
                    : 32768 === (c.mode & 61440)
                      ? ((c.za = N.Ua.file.node),
                        (c.xa = N.Ua.file.stream),
                        (c.Ga = 0),
                        (c.ya = null))
                      : 40960 === (c.mode & 61440)
                        ? ((c.za = N.Ua.link.node), (c.xa = N.Ua.link.stream))
                        : 8192 === (c.mode & 61440) &&
                          ((c.za = N.Ua.$b.node), (c.xa = N.Ua.$b.stream));
                  c.gb = c.Ra = c.Oa = Date.now();
                  a && ((a.ya[b] = c), (a.gb = a.Ra = a.Oa = c.gb));
                  return c;
                },
                Dd(a) {
                  return a.ya
                    ? a.ya.subarray
                      ? a.ya.subarray(0, a.Ga)
                      : new Uint8Array(a.ya)
                    : new Uint8Array(0);
                },
                za: {
                      ...
                      a.Ga != b &&
                        (0 == b
                          ...
                          : ((c = a.ya),
                            ...
                            c && a.ya.set(c.subarray(0, Math.min(b, a.Ga))),
                            (a.Ga = b))));
                  },
                  nb() {
                    N.Jb ||
                      ((N.Jb = new M(44)),
                      (N.Jb.stack = "<generic error, no stack>"));
                    throw N.Jb;
                  },
                  wb(a, b, c, d) {
                  ...
                  qc(a, b, c) {
                    ...
                    if (d) {
                      if (16384 === (a.mode & 61440))
                        for (var e in d.ya) throw new M(55);
                    ...
                    b.ya[c] = a;
                    a.name = c;
                    b.Oa = b.Ra = a.parent.Oa = a.parent.Ra = Date.now();
                  },
                  wc(a, b) {
                    delete a.ya[b];
                    a.Oa = a.Ra = Date.now();
                  ...
                  sc(a, b) {
                    var c = ub(a, b),
                      d;
                    for (d in c.ya) throw new M(55);
                    delete a.ya[b];
                    a.Oa = a.Ra = Date.now();
                  },
                  Rb(a) {
                    return [".", "..", ...Object.keys(a.ya)];
                  },
                  Db(a, b, c) {
                ...
                xa: {
                  read(a, b, c, d, e) {
                    var f = a.node.ya;
                    if (e >= a.node.Ga) return 0;
                    a = Math.min(a.node.Ga - e, d);
                  ...
                  write(a, b, c, d, e, f) {
                    ...
                    if (b.subarray && (!a.ya || a.ya.subarray)) {
                      if (f) return ((a.ya = b.subarray(c, c + d)), (a.Ga = d));
                      if (0 === a.Ga && 0 === e)
                        return ((a.ya = b.slice(c, c + d)), (a.Ga = d));
                      if (e + d <= a.Ga)
                        return (a.ya.set(b.subarray(c, c + d), e), d);
                    }
                    f = e + d;
                    var g = a.ya ? a.ya.length : 0;
                    g >= f ||
                      ((f = Math.max(f, (g * (1048576 > g ? 2 : 1.125)) >>> 0)),
                      0 != g && (f = Math.max(f, 256)),
                      (g = a.ya),
                      (a.ya = new Uint8Array(f)),
                      0 < a.Ga && a.ya.set(g.subarray(0, a.Ga), 0));
                    if (a.ya.subarray && b.subarray)
                      a.ya.set(b.subarray(c, c + d), e);
                    else for (f = 0; f < d; f++) a.ya[e + f] = b[c + f];
                    a.Ga = Math.max(a.Ga, e + d);
                    return d;
                  },
                  Ta(a, b, c) {
                    1 === c
                  ...
                  if ("." !== a[f])
                    if (".." === a[f])
                      ...
                      try {
                        ...
                        if (44 === h?.bb && g && b.fd) return { path: e };
                        throw h;
                      }
                      !d.xb || (g && !b.Lb) || (d = d.xb.root);
                      if (40960 === (d.mode & 61440) && (!g || b.Kb)) {
                        if (!d.za.pb) throw new M(52);
                        d = d.za.pb(d);
                        "/" === d.charAt(0) || (d = bb(e) + "/" + d);
            ...
            function Pb(a, b) {
              var c = "/" === b;
              if (c && yb) throw new M(10);
              if (!c && b) {
                var d = Hb(b, { Lb: !1 });
                b = d.path;
                d = d.node;
                if (d.xb) throw new M(10);
                if (16384 !== (d.mode & 61440)) throw new M(54);
              }
              b = { type: a, Id: {}, kc: b, dd: [] };
              a = a.$a(b);
              a.$a = b;
              b.root = a;
              c ? (yb = a) : d && ((d.xb = b), d.$a && d.$a.dd.push(b));
            }
            function Vb(a, b, c) {
              var d = Hb(a, { parent: !0 }).node;
              a = a && a.match(/([^\/]+|\/)\/*$/)[1];
              if (!a) throw new M(28);
              if ("." === a || ".." === a) throw new M(20);
              var e = Kb(d, a);
              if (e) throw new M(e);
              if (!d.za.wb) throw new M(63);
              return d.za.wb(d, a, b, c);
            }
            function Wb(a) {
              return Vb(a, 16895, 0);
            }
            ...
            function Yb(a, b) {
              if (!eb(a)) throw new M(44);
              var c = Hb(b, { parent: !0 }).node;
              if (!c) throw new M(44);
              b = b && b.match(/([^\/]+|\/)\/*$/)[1];
              var d = Kb(c, b);
              if (d) throw new M(d);
              if (!c.za.Db) throw new M(63);
              c.za.Db(c, b, a);
            }
            function Zb(a, b, c = 438) {
              if ("" === a) throw new M(44);
              if ("string" == typeof b) {
                var d = {
                  r: 0,
              ...
              if (b & 65536 && 16384 !== (d.mode & 61440)) throw new M(54);
              if (
                !f &&
                (e = d
                  ? 40960 === (d.mode & 61440)
                    ? 32
                    : 16384 === (d.mode & 61440) && ("r" !== Jb(b) || b & 576)
                      ? 31
                      : Ib(d, Jb(b))
                  : 44)
              )
              ...
              if (b & 512 && !f) {
                e = d;
                e = "string" == typeof e ? Hb(e, { Kb: !0 }).node : e;
                if (16384 === (e.mode & 61440)) throw new M(31);
              ...
              h.xa.open && h.xa.open(h);
              f &&
                ((c &= 511),
                (d = "string" == typeof d ? Hb(d, { Kb: !0 }).node : d),
                Ob(d, {
            ...
            function $b(a, b, c) {
              if (null === a.cb) throw new M(8);
              if (!a.seekable || !a.xa.Ta) throw new M(70);
            ...
            function ac(a, b, c) {
              ...
              ob(e, {
                ...
                read(f, g, h, m) {
                  for (var l = 0, u = 0; u < m; u++) {
                    try {
                      var y = b();
                    } catch (t) {
                      throw new M(29);
                    }
                    if (void 0 === y && 0 === l) throw new M(6);
                    if (null === y || void 0 === y) break;
                    l++;
                    g[h + u] = y;
                  }
                  l && (f.node.gb = Date.now());
                  return l;
                },
                write(f, g, h, m) {
                  for (var l = 0; l < m; l++)
                  ...
                  m && (f.node.Ra = f.node.Oa = Date.now());
                  return l;
                },
              });
              Xb(a, d, e);
            ...
            var bc = {},
              Ya = void 0,
              cc = (a, b) => Object.defineProperty(b, "name", { value: a }),
              dc = [],
              ec = [0, 1, , 1, null, 1, !0, 1, !1, 1],
            ...
            var T = (a) => {
              ...
              qc = (a) => {
                ...
                pc = new FinalizationRegistry((b) => {
                  ...
                  --b.count.value;
                  0 === b.count.value &&
                    (b.Ja ? b.Pa.Va(b.Ja) : b.Da.wa.Va(b.Ba));
                });
                qc = (b) => {
                  var c = b.va;
                  c.Ja && pc.register(b, { va: c }, b);
                  return b;
                };
                oc = (b) => {
                  pc.unregister(b);
              ...
              X = (a, b, c) => {
                function d(h) {
                  ...
                  if (h.length !== a.length)
                    throw new wc("Mismatched type converter count");
                  for (var m = 0; m < a.length; ++m) U(a[m], h[m]);
                }
                a.forEach((h) => (vc[h] = b));
            ...
            function xc(a, b, c = {}) {
              ...
              delete vc[a];
              uc.hasOwnProperty(a) &&
                ((b = uc[a]), delete uc[a], b.forEach((e) => e()));
            }
            function U(a, b, c = {}) {
              return xc(a, b, c);
            }
            var yc = (a, b, c) => {
              ...
              zc = (a) => {
                throw new P(a.va.Da.wa.name + " instance already deleted");
              },
              Ac = [];
            function Bc() {}
            var Cc = {},
              ...
              Ec = (a, b, c) => {
                if (k.hasOwnProperty(a)) {
                  if (
                    void 0 === c ||
                    (void 0 !== k[a].Fa && void 0 !== k[a].Fa[c])
                  )
                    throw new P(`Cannot register public name '${a}' twice`);
                  Dc(k, a, a);
                  if (k[a].Fa.hasOwnProperty(c))
                    throw new P(
            ...
            function Jc(a, b) {
              if (null === b) {
                if (this.Nb) throw new P(`null is not a valid ${this.name}`);
                return 0;
              }
              if (!b.va)
                throw new P(`Cannot pass "${Ic(b)}" as a ${this.name}`);
              if (!b.va.Ba)
                throw new P(
                  `Cannot pass deleted object as a pointer of type ${this.name}`,
                );
              return Hc(b.va.Ba, b.va.Da.wa, this.wa);
            }
            function Kc(a, b) {
              if (null === b) {
                if (this.Nb) throw new P(`null is not a valid ${this.name}`);
              ...
              if (!this.ub && b.va.Da.ub)
                throw new P(
                  `Cannot convert argument of type ${b.va.Pa ? b.va.Pa.name : b.va.Da.name} to parameter type ${this.name}`,
                );
              c = Hc(b.va.Ba, b.va.Da.wa, this.wa);
              if (this.vb) {
                if (void 0 === b.va.Ja)
                  throw new P(
                ...
                switch (this.md) {
                  ...
                  case 2:
                    ...
                    break;
                  default:
                    throw new P("Unsupported sharing policy");
                }
              }
              return c;
            }
            function Lc(a, b) {
              ...
              if (b.va.Da.ub)
                throw new P(
                  `Cannot convert argument of type ${b.va.Da.name} to parameter type ${this.name}`,
                );
              return Hc(b.va.Ba, b.va.Da.wa, this.wa);
            }
            var Mc = (a, b, c) => {
              ...
              Oc = (a, b) => {
                if (!b.Da || !b.Ba)
                  throw new wc("makeClassHandle requires ptr and ptrType");
                if (!!b.Pa !== !!b.Ja)
                  throw new wc(
                    "Both smartPtrType and smartPtr must be specified",
                  );
                b.count = { value: 1 };
                return qc(Object.create(a, { va: { value: b, writable: !0 } }));
              };
            function Pc(a, b, c, d, e, f, g, h, m, l, u) {
              this.name = a;
              this.wa = b;
              this.Nb = c;
              this.ub = d;
              ...
              e || void 0 !== b.Ia
                ? (this.Ea = Kc)
                : ((this.Ea = d ? Jc : Lc), (this.La = null));
            }
            var Qc = (a, b, c) => {
                if (!k.hasOwnProperty(a))
                  throw new wc("Replacing nonexistent public symbol");
            ...
            var Tc = (a, b) => {
              function c(f) {
                e[f] ||
                  jc[f] ||
                  (vc[f] ? vc[f].forEach(c) : (d.push(f), (e[f] = !0)));
              }
              var d = [],
                e = {};
              b.forEach(c);
              throw new Sc(`${a}: ` + d.map(mc).join([", "]));
            };
            function Uc(a) {
            ...
            function Yc(a, b, c, d, e) {
              ...
              return cc(a, function (...w) {
                ...
                for (var p = 0; p < l; ++p)
                  ((u[p] = b[p + 2].Ea(t, w[p])), y.push(u[p]));
                w = d(...y);
                if (h) sc(t);
                else
                  for (p = g ? 1 : 2; p < b.length; p++) {
                    var H = 1 === p ? x : u[p - 2];
                    null !== b[p].La && b[p].La(H);
                  }
                x = m ? b[0].Aa(w) : void 0;
                return x;
              });
            ...
            var Zc = (a, b) => {
              ...
              ad = (a, b, c) => {
                ...
                if (!(a instanceof b.wa.constructor))
                  throw new P(
                ...
                return Hc(a.va.Ba, a.va.Da.wa, b.wa);
              },
              bd = (a) => {
                9 < a && 0 === --ec[a + 1] && ((ec[a] = void 0), dc.push(a));
              },
              cd = {
                name: "emscripten::val",
                Aa: (a) => {
              ...
              dd = (a, b, c) => {
                switch (b) {
                  ...
                  case 2:
                    return c
                      ? function (d) {
                          return this.Aa(Ca[d >> 1]);
                        }
                      : function (d) {
                          return this.Aa(Fa[d >> 1]);
                        };
                  case 4:
                    return c
                      ? function (d) {
                          return this.Aa(B[d >> 2]);
                        }
                      : function (d) {
                          return this.Aa(J[d >> 2]);
                        };
                  default:
                    throw new TypeError(`invalid integer width (${b}): ${a}`);
                }
              ...
              ed = (a, b) => {
                switch (b) {
                  case 4:
                    return function (c) {
                      return this.Aa(Ga[c >> 2]);
                    };
                  case 8:
                    return function (c) {
                      return this.Aa(Ha[c >> 3]);
                    };
                  default:
                    throw new TypeError(`invalid float width (${b}): ${a}`);
                }
              },
              fd = globalThis.TextDecoder
                ? new TextDecoder("utf-16le")
                : void 0,
              gd = (a, b, c) => {
                a >>= 1;
                b = gb(Fa, a, b / 2, c);
                if (16 < b - a && fd) return fd.decode(Fa.subarray(a, b));
                for (c = ""; a < b; ++a) c += String.fromCharCode(Fa[a]);
                return c;
              },
              hd = (a, b, c) => {
                c ??= 2147483647;
              ...
              td = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335],
              ud = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334],
              vd = {},
              wd = (a) => {
                if (!(a instanceof Sa || "unwind" == a)) throw a;
              },
              xd = (a) => {
                za = a;
                Xa || 0 < nd || (k.onExit?.(a), (ya = !0));
                throw new Sa(a);
              },
              yd = (a) => {
                if (!ya)
            ...
            (function () {
              Wb("/dev");
              ob(259, { read: () => 0, write: (d, e, f, g) => g, Ta: () => 0 });
              Xb("/dev/null", 259);
              nb(1280, qb);
              nb(1536, rb);
              Xb("/dev/tty", 1280);
            ...
            (() => {
              ...
              Object.assign(a, {
                isAliasOf: function (c) {
                  if (!(this instanceof Bc && c instanceof Bc)) return !1;
                  var d = this.va.Da.wa,
                    e = this.va.Ba;
                  c.va = c.va;
                  var f = c.va.Da.wa;
                  for (c = c.va.Ba; d.Ia;) ((e = d.qb(e)), (d = d.Ia));
                  for (; f.Ia;) ((c = f.qb(c)), (f = f.Ia));
                  return d === f && e === c;
                },
                clone: function () {
                  this.va.Ba || zc(this);
                  if (this.va.kb) return ((this.va.count.value += 1), this);
                  var c = qc,
                    d = Object,
                    e = d.create,
                ...
                ["delete"]() {
                  this.va.Ba || zc(this);
                  if (this.va.mb && !this.va.kb)
                    throw new P("Object already scheduled for deletion");
                  oc(this);
                  var c = this.va;
                  --c.count.value;
                  0 === c.count.value &&
                    (c.Ja ? c.Pa.Va(c.Ja) : c.Da.wa.Va(c.Ba));
            ...
            Object.assign(Pc.prototype, {
              ...
              Aa: function (a) {
                function b() {
                  return this.vb
                    ? Oc(this.wa.Sa, { Da: this.gd, Ba: c, Pa: this, Ja: a })
                    : Oc(this.wa.Sa, { Da: this, Ba: a });
                }
                var c = this.Qc(a);
                if (!c) return (this.ac(a), null);
                var d = Nc(this.wa, c);
                if (void 0 !== d) {
                  if (0 === d.va.count.value)
                    return ((d.va.Ba = c), (d.va.Ja = a), d.clone());
                  d = d.clone();
                  this.ac(a);
                  return d;
                }
                ...
                var e = Mc(c, this.wa, d.wa);
                return null === e
                  ? b.call(this)
                  : this.vb
                    ? Oc(d.wa.Sa, { Da: d, Ba: e, Pa: this, Ja: a })
                    : Oc(d.wa.Sa, { Da: d, Ba: e });
              },
            });
            k.noExitRuntime && (Xa = k.noExitRuntime);
            k.print && (ta = k.print);
            k.printErr && (wa = k.printErr);
            ...
            var Gd = {
                  ...
                  if ("undefined" === typeof window.miniaudio) {
                    ...
                    f.unlock = function () {
                      for (var g = 0; g < f.devices.length; ++g) {
                        ...
                        null != h &&
                          null != h.Qa &&
                          h.state === f.device_state.started &&
                          h.Qa.resume().then(
                            () => {
                              Dd(h.nc);
                            },
                ...
                239089: () => {
                  "undefined" !== typeof window.miniaudio &&
                    (window.miniaudio.unlock_event_types.map(function (a) {
                ...
                239668: (a, b, c, d, e, f) => {
                  ...
                  a == window.miniaudio.device_type.playback &&
                    0 != c &&
                    (h.sampleRate = c);
                  g.Qa = new (window.AudioContext || window.webkitAudioContext)(
                    h,
                  );
                  g.Qa.suspend();
                  ...
                  g.fb = g.Qa.createScriptProcessor(d, c, b);
                  g.fb.onaudioprocess = function (m) {
                    if (null == g.tb || 0 == g.tb.length)
                      g.tb = new Float32Array(Ga.buffer, e, d * b);
                    if (
                      a == window.miniaudio.device_type.capture ||
                      a == window.miniaudio.device_type.duplex
                    ) {
                      for (var l = 0; l < b; l += 1)
                        for (
                          var u = m.inputBuffer.getChannelData(l),
                            y = g.tb,
                            t = 0;
                          t < d;
                          t += 1
                    ...
                    if (
                      ...
                      for (
                        Fd(f, d, e), l = 0;
                        l < m.outputBuffer.numberOfChannels;
                        ++l
                      )
                        for (
                          u = m.outputBuffer.getChannelData(l), y = g.tb, t = 0;
                          t < d;
                          t += 1
                        )
                          u[t] = y[t * b + l];
                      ...
                      for (l = 0; l < m.outputBuffer.numberOfChannels; ++l)
                        m.outputBuffer.getChannelData(l).fill(0);
                  };
                  (a != window.miniaudio.device_type.capture &&
                    a != window.miniaudio.device_type.duplex) ||
                    navigator.mediaDevices
                      ...
                      .then(function (m) {
                        g.Cb = g.Qa.createMediaStreamSource(m);
                        g.Cb.connect(g.fb);
                        g.fb.connect(g.Qa.destination);
                      })
                      .catch(function (m) {
                ...
                242545: (a) =>
                  window.miniaudio.get_device_by_index(a).Qa.sampleRate,
                242618: (a) => {
                  a = window.miniaudio.get_device_by_index(a);
                  void 0 !== a.fb &&
                    ((a.fb.onaudioprocess = function () {}),
                    a.fb.disconnect(),
                    (a.fb = void 0));
                  void 0 !== a.Cb && (a.Cb.disconnect(), (a.Cb = void 0));
                  a.Qa.close();
                  a.Qa = void 0;
                  a.nc = void 0;
                },
              ...
              Nd = {
                s: function (a, b, c) {
                  ...
                  try {
                    ...
                    if ("undefined" == typeof bc || "ErrnoError" !== f.name)
                      throw f;
                    return -f.bb;
                  }
                },
                L: function (a, b, c) {
                  ...
                  try {
                    ...
                    switch (b) {
                      ...
                      case 21531:
                        e = Za();
                        if (!d.xa.Vc) throw new M(59);
                        return d.xa.Vc(d, b, e);
                      case 21523:
                        if (!d.Ca) return -59;
                        d.Ca.ab.Yc &&
                          ((f = [24, 80]),
                    ...
                    if ("undefined" == typeof bc || "ErrnoError" !== g.name)
                      throw g;
                    return -g.bb;
                  }
                },
                M: function (a, b, c, d) {
                  ...
                  try {
                    ...
                    if ("undefined" == typeof bc || "ErrnoError" !== h.name)
                      throw h;
                    return -h.bb;
                  }
                },
                ...
                o: (a, b, c) => {
                  ...
                  var d = b.wa,
                    ...
                    g = d.Ia.constructor;
                  a = cc(a, function (...h) {
                    for (var m of d.Ia.oc)
                      if (this[m] === f[m])
                        throw new gc(
                          `Pure virtual function ${m} must be implemented in JavaScript`,
                        );
                  ...
                  e.__construct = function (...h) {
                    ...
                    m.kb = !0;
                    Object.defineProperties(this, { va: { value: m } });
                    qc(this);
                    h = m.Ba;
                    h = ic(d, h);
                    if (hc.hasOwnProperty(h))
                      throw new P(
                        `Tried to register registered instance: ${h}`,
                      );
                    hc[h] = this;
                  };
                  e.__destruct = function () {
                    ...
                    if (hc.hasOwnProperty(h)) delete hc[h];
                      ...
                      throw new P(
                        `Tried to unregister unregistered instance: ${h}`,
                      );
                  };
                ...
                _: (a) => {
                  ...
                  var c = b.Qb,
                    d = b.Va,
                    e = b.dc,
                    f = e.map((g) => g.Tc).concat(e.map((g) => g.kd));
                  X([a], f, (g) => {
                    var h = {},
                      m,
                      l;
                    ...
                    return [
                      {
                        ...
                        Aa: (u) => {
                          var y = {},
                            t;
                          for (t in h) y[t] = h[t].read(u);
                          d(u);
                          return y;
                        },
                        Ea: (u, y) => {
                          for (var t in h)
                            if (!(t in y || h[t].optional))
                              throw new TypeError(`Missing field: "${t}"`);
                          var w = c();
                          for (t in h) h[t].write(w, y[t]);
                          null !== u && u.push(d, w);
                          return w;
                        },
                        Ma: tc,
                ...
                c: (a, b, c, d, e, f, g, h, m, l, u, y, t) => {
                  ...
                  var w = Fc(u);
                  Ec(w, function () {
                    Tc(`Cannot construct ${u} due to unbound types`, [d]);
                  });
                  X([a, b, c], d ? [d] : [], (x) => {
                    x = x[0];
                    if (d) {
                    ...
                    x = cc(u, function (...O) {
                      if (Object.getPrototypeOf(this) !== F)
                        throw new P(`Use 'new' to construct ${u}`);
                      if (void 0 === q.hb)
                        throw new P(`${u} has no accessible constructor`);
                      var S = q.hb[O.length];
                      if (void 0 === S)
                        throw new P(
                          `Tried to invoke ctor of ${u} with invalid number of parameters (${O.length}) - expected (${Object.keys(q.hb).toString()}) parameters instead!`,
                        );
                      return S.apply(this, O);
                    });
                    var F = Object.create(H, { constructor: { value: x } });
                    x.prototype = F;
                    var q = new Gc(u, x, F, t, p, f, h, l);
                    if (q.Ia) {
                      var K;
                      (K = q.Ia).rb ?? (K.rb = []);
                      q.Ia.rb.push(q);
                    ...
                    p = new Pc(u, q, !0, !1, !1);
                    K = new Pc(u + "*", q, !1, !1, !1);
                    H = new Pc(u + " const*", q, !1, !0, !1);
                    Cc[a] = { pointerType: K, Gc: H };
                    Qc(w, x);
                    return [p, K, H];
                  });
                },
                k: (a, b, c, d, e, f, g) => {
                  ...
                  X([], [a], (m) => {
                    function l() {
                      Tc(`Cannot call ${u} due to unbound types`, h);
                    }
                    m = m[0];
                    var u = `${m.name}.${b}`;
                    b.startsWith("@@") && (b = Symbol[b.substring(2)]);
                    var y = m.wa.constructor;
                    void 0 === y[b]
                      ? ((l.Za = c - 1), (y[b] = l))
                      : (Dc(y, b, u), (y[b].Fa[c - 1] = l));
                    X([], h, (t) => {
                      t = Yc(u, [t[0], null].concat(t.slice(1)), null, f, g);
                      void 0 === y[b].Fa
                        ? ((t.Za = c - 1), (y[b] = t))
                        : (y[b].Fa[c - 1] = t);
                      if (m.wa.rb)
                        for (const w of m.wa.rb)
                          w.constructor.hasOwnProperty(b) ||
                            (w.constructor[b] = t);
                      return [];
                    });
                    return [];
                ...
                q: (a, b, c, d, e, f, g, h) => {
                  ...
                  X([], [a], (m) => {
                    ...
                    var l = `${m.name}.${b}`,
                      u = {
                        get() {
                          Tc(`Cannot access ${l} due to unbound types`, [c]);
                        },
                        enumerable: !0,
                        configurable: !0,
                      };
                    ...
                    Object.defineProperty(m.wa.constructor, b, u);
                    X([], [c], (y) => {
                      y = y[0];
                      var t = {
                        get() {
                      ...
                      Object.defineProperty(m.wa.constructor, b, t);
                      return [];
                    });
                    return [];
                  });
                ...
                n: (a, b, c, d, e, f) => {
                  ...
                  X([], [a], (h) => {
                    ...
                    void 0 === h.wa.hb && (h.wa.hb = []);
                    if (void 0 !== h.wa.hb[b - 1])
                      throw new P(
                    ...
                    h.wa.hb[b - 1] = () => {
                      Tc(`Cannot construct ${h.name} due to unbound types`, g);
                    };
                    X([], g, (l) => {
                      l.splice(1, 0, null);
                      h.wa.hb[b - 1] = Yc(m, l, null, e, f);
                      return [];
                    });
                    return [];
                  });
                ...
                a: (a, b, c, d, e, f, g, h) => {
                  ...
                  X([], [a], (l) => {
                    function u() {
                      Tc(`Cannot call ${y} due to unbound types`, m);
                    }
                    l = l[0];
                    var y = `${l.name}.${b}`;
                    b.startsWith("@@") && (b = Symbol[b.substring(2)]);
                    ...
                    (void 0 === w.Fa &&
                      w.className !== l.name &&
                      w.Za === c - 2)
                      ? ((u.Za = c - 2), (u.className = l.name), (t[b] = u))
                      : (Dc(t, b, y), (t[b].Fa[c - 2] = u));
                    X([], m, (x) => {
                      x = Yc(y, x, l, f, g);
                      void 0 === t[b].Fa
                        ? ((x.Za = c - 2), (t[b] = x))
                ...
                b: (a, b, c, d, e, f, g, h, m, l) => {
                  ...
                  X([], [a], (u) => {
                    ...
                    var y = `${u.name}.${b}`,
                      t = {
                        get() {
                          Tc(`Cannot access ${y} due to unbound types`, [c, g]);
                        },
                        enumerable: !0,
                        configurable: !0,
                      };
                    t.set = m
                      ? () =>
                          Tc(`Cannot access ${y} due to unbound types`, [c, g])
                      : () => {
                          throw new P(y + " is a read-only property");
                        };
                    Object.defineProperty(u.wa.Sa, b, t);
                    X([], m ? [c, g] : [c], (w) => {
                      var x = w[0],
                        p = {
                          get() {
                            var F = ad(this, u, y + " getter");
                            return x.Aa(e(f, F));
                          },
                          enumerable: !0,
                        };
                      if (m) {
                        ...
                        var H = w[1];
                        p.set = function (F) {
                          var q = ad(this, u, y + " setter"),
                            K = [];
                          m(l, q, H.Ea(K, F));
                          sc(K);
                        };
                      }
                      Object.defineProperty(u.wa.Sa, b, p);
                      return [];
                    });
                    return [];
                  });
                ...
                i: (a, b, c, d, e, f) => {
                  ...
                  Ec(
                    a,
                    function () {
                      Tc(`Cannot call ${a} due to unbound types`, g);
                    },
                    b - 1,
                  );
                  X([], g, (h) => {
                    Qc(
                      a,
                      Yc(a, [h[0], null].concat(h.slice(1)), null, e, f),
                      b - 1,
                    );
                    return [];
                  });
                ...
                h: (a, b, c) => {
                  function d(f) {
                    return new e(v.buffer, J[(f + 4) >> 2], J[f >> 2]);
                  }
                  var e = [
                    Int8Array,
                    Uint8Array,
                ...
                U: (a, b) => {
                  ...
                  U(a, {
                    ...
                    Ea(c, d) {
                      ...
                      if (!(
                        e ||
                        (ArrayBuffer.isView(d) && 1 == d.BYTES_PER_ELEMENT)
                      ))
                        throw new P("Cannot pass non-string to std::string");
                      var f = e ? kb(d) : d.length;
                      var g = Hd(4 + f + 1),
                        h = g + 4;
                      J[g >> 2] = f;
                      e ? lb(d, A, h, f + 1) : A.set(d, h);
                      null !== c && c.push(lc, g);
                      return g;
                    },
                    Ma: tc,
                ...
                aa: (a, b, c, d, e, f) => {
                  rc[a] = { name: T(b), Qb: Y(c, d), Va: Y(e, f), dc: [] };
                },
                $: (a, b, c, d, e, f, g, h, m, l) => {
                  rc[a].dc.push({
                    Nc: T(b),
                ...
                f: (a, b, c) => {
                  var [d, ...e] = qd(a, b),
                    f = d.Ea.bind(d),
                    g = e.map((m) => m.Ma.bind(m));
                  a--;
                  var h = Array(a);
                  b = `methodCaller<(${e.map((m) => m.name)}) => ${d.name}>`;
                  return pd(
                    cc(b, (m, l, u, y) => {
                      for (var t = 0, w = 0; w < a; ++w)
                        ((h[w] = g[w](y + t)), (t += 8));
                      switch (c) {
                        case 0:
                          var x = Q(m).apply(null, h);
                          break;
                        case 2:
                          x = Reflect.construct(Q(m), h);
                          break;
                        case 3:
                          x = h[0];
                          break;
                ...
                B: (a, b) => {
                  vd[a] && (clearTimeout(vd[a].id), delete vd[a]);
                  if (!b) return 0;
                  var c = setTimeout(() => {
                    delete vd[a];
                    yd(() => Id(a, performance.now()));
                  }, b);
                  vd[a] = { id: c, Kd: b };
                  return 0;
                },
                H: (a, b, c, d) => {
                  ...
                  b = b(e);
                  e < f
                    ? (lb(a, A, c, 17), lb(b, A, d, 17))
                    : (lb(a, A, d, 17), lb(b, A, c, 17));
                },
                O: function (a, b, c) {
                ...
                r: function (a) {
                  try {
                    var b = Lb(a);
                    if (null === b.cb) throw new M(8);
                    b.Mb && (b.Mb = null);
                    try {
                      b.xa.close && b.xa.close(b);
                    } catch (c) {
                      throw c;
                    } finally {
                      Ab[b.cb] = null;
                    ...
                    if ("undefined" == typeof bc || "ErrnoError" !== c.name)
                      throw c;
                    return c.bb;
                  }
                },
                K: function (a, b, c, d) {
                  try {
                    ...
                    if ("undefined" == typeof bc || "ErrnoError" !== q.name)
                      throw q;
                    return q.bb;
                  }
                },
                  ...
                  try {
                    a: {
                      ...
                      for (var f, g = (b = 0); g < c; g++) {
                        ...
                        if (0 > y || 0 > t) throw new M(28);
                        if (null === l.cb) throw new M(8);
                        if (0 === (l.flags & 2097155)) throw new M(8);
                        if (16384 === (l.node.mode & 61440)) throw new M(31);
                        if (!l.xa.write) throw new M(28);
                        l.seekable && l.flags & 1024 && $b(l, 0, 2);
                        var x = "undefined" != typeof t;
                        if (!x) t = l.position;
                        else if (!l.seekable) throw new M(70);
                        var p = l.xa.write(l, w, u, y, t, void 0);
                        x || (l.position += p);
                        var H = p;
                        if (0 > H) {
                          var F = -1;
                ...
                z: xd,
                S: function (a, b, c) {
                  b = new Uint8Array(Ma.buffer, b, c);
                  c = new Uint8Array(c);
                  c.set(b);
                  createImageBitmap(new Blob([c]))
                    .then(function (d) {
                      var e = new OffscreenCanvas(d.width, d.height).getContext(
                        "2d",
                      );
                      e.drawImage(d, 0, 0);
            ...
            var Od;
            Od = await (async function () {
              function a(c) {
                c = Od = c.exports;
                lc = c.ga;
                Hd = c.ha;
                kc = c.ia;
                k._wasm_image_decode_complete = c.ja;
                k._wasm_image_decode_error = c.ka;
                Dd = k._ma_device__on_notification_unlocked = c.la;
                k._ma_malloc_emscripten = c.ma;
                k._ma_free_emscripten = c.na;
                Ed = k._ma_device_process_pcm_frames_capture__webaudio = c.oa;
                Fd = k._ma_device_process_pcm_frames_playback__webaudio = c.pa;
                Id = c.ra;
                Jd = c.sa;
                Kd = c.ta;
                Ld = c.ua;
              ...
              Oa ??= k.locateFile
                ? k.locateFile("canvas_advanced.wasm", ma)
                : ma + "canvas_advanced.wasm";
              ...
              function a() {
                ...
                if (!ya) {
                  ...
                  if (!k.noFSInit && !Cb) {
                    ...
                    c ??= k.stdout;
                    d ??= k.stderr;
                    b ? ac("stdin", b) : Yb("/dev/tty", "/dev/stdin");
                    c ? ac("stdout", null, c) : Yb("/dev/tty", "/dev/stdout");
                    d ? ac("stderr", null, d) : Yb("/dev/tty1", "/dev/stderr");
                    Zb("/dev/stdin", 0);
                    Zb("/dev/stdout", 1);
                    Zb("/dev/stderr", 1);
                  }
      ...
      /***/ (
        ...
        __webpack_require__.r(__webpack_exports__);
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ AccessibilityOverlay: () =>
            /* reexport safe */ _accessibilityOverlay__WEBPACK_IMPORTED_MODULE_1__.AccessibilityOverlay,
          /* harmony export */ SemanticActionType: () =>
            /* reexport safe */ _types__WEBPACK_IMPORTED_MODULE_2__.SemanticActionType,
          /* harmony export */ SemanticMode: () =>
            /* reexport safe */ _types__WEBPACK_IMPORTED_MODULE_2__.SemanticMode,
          /* harmony export */ SemanticRole: () =>
            /* reexport safe */ _types__WEBPACK_IMPORTED_MODULE_2__.SemanticRole,
          /* harmony export */ SemanticState: () =>
            /* reexport safe */ _types__WEBPACK_IMPORTED_MODULE_2__.SemanticState,
          /* harmony export */ SemanticTrait: () =>
            /* reexport safe */ _types__WEBPACK_IMPORTED_MODULE_2__.SemanticTrait,
          /* harmony export */ SemanticTreeModel: () =>
            /* reexport safe */ _semanticTreeModel__WEBPACK_IMPORTED_MODULE_0__.SemanticTreeModel,
          /* harmony export */ hasState: () =>
            /* reexport safe */ _types__WEBPACK_IMPORTED_MODULE_2__.hasState,
          /* harmony export */ hasTrait: () =>
            /* reexport safe */ _types__WEBPACK_IMPORTED_MODULE_2__.hasTrait,
          /* harmony export */ roleName: () =>
            /* reexport safe */ _types__WEBPACK_IMPORTED_MODULE_2__.roleName,
          /* harmony export */ stateNames: () =>
            /* reexport safe */ _types__WEBPACK_IMPORTED_MODULE_2__.stateNames,
          /* harmony export */ traitNames: () =>
            /* reexport safe */ _types__WEBPACK_IMPORTED_MODULE_2__.traitNames,
          /* harmony export */
        });
        /* harmony import */ var _semanticTreeModel__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(7);
        /* harmony import */ var _accessibilityOverlay__WEBPACK_IMPORTED_MODULE_1__ =
      ...
      /***/ (
        ...
        var SemanticTreeModel = /** @class */ (function () {
          ...
          SemanticTreeModel.prototype.detach = function (id) {
            ...
            if (node.parentId < 0) {
              ...
              if (parent_1) {
                ...
                if (idx !== -1) parent_1.children.splice(idx, 1);
              }
            }
          };
          /** Attach a node under a parent at a given sibling index (or as root). */
          SemanticTreeModel.prototype.attach = function (
            id,
            parentId,
            siblingIndex,
          ) {
          ...
          SemanticTreeModel.prototype.applyDiff = function (diff) {
            ...
            for (var _h = 0, _j = diff.childrenUpdated; _h < _j.length; _h++) {
              ...
              if (update.parentId < 0) {
                var next = update.childIds.filter(function (id) {
                  return _this._nodesById.has(id);
                });
          ...
          SemanticTreeModel.prototype.logDiff = function (
            diff,
            semanticChanged,
            geometryChanged,
          ) {
            var lines = [
              "[rive:semantics] semantic v".concat(this._semanticVersion) +
                (geometryChanged
                  ? " geometry v".concat(this._geometryVersion)
                  : "") +
            ...
            for (var _b = 0, _c = diff.added; _b < _c.length; _b++) {
              ...
              lines.push(
                "  + added #"
                  .concat(n.id, " ")
                  .concat(
                    (0, _types__WEBPACK_IMPORTED_MODULE_0__.roleName)(n.role),
                  ) +
                  (n.label ? ' "'.concat(n.label, '"') : "") +
                  " bounds:("
                    .concat(n.minX.toFixed(1), ",")
                    .concat(n.minY.toFixed(1), ")-(")
                    .concat(n.maxX.toFixed(1), ",")
                    .concat(n.maxY.toFixed(1), ")") +
                  " states=[".concat(
                    (0, _types__WEBPACK_IMPORTED_MODULE_0__.stateNames)(
                      n.stateFlags,
                    ),
                    "]",
                  ) +
                  " traits=[".concat(
                    (0, _types__WEBPACK_IMPORTED_MODULE_0__.traitNames)(
                      n.traitFlags,
                    ),
                    "]",
                  ),
            ...
            for (var _d = 0, _e = diff.moved; _d < _e.length; _d++) {
              ...
              lines.push(
                "  ~ moved #"
                  .concat(n.id, " \u2192 parent=")
                  .concat(n.parentId, " idx=")
                  .concat(n.siblingIndex) +
                  " bounds:("
                    .concat(n.minX.toFixed(1), ",")
                    .concat(n.minY.toFixed(1), ")-(")
                    .concat(n.maxX.toFixed(1), ",")
            ...
            for (var _f = 0, _g = diff.childrenUpdated; _f < _g.length; _f++) {
              ...
              lines.push(
                "  \u2195 children of "
                  .concat(u.parentId < 0 ? "root" : "#" + u.parentId, ": [")
                  .concat(u.childIds.join(", "), "]"),
              );
            }
      ...
      /***/ (
        ...
        var _roleNames = {};
        for (
          var _i = 0, _a = Object.entries(SemanticRole);
          _i < _a.length;
          _i++
        ) {
          var _b = _a[_i],
        ...
        function roleName(role) {
          var _a;
          return (_a = _roleNames[role]) !== null && _a !== void 0
            ? _a
            : "unknown(".concat(role, ")");
        }
        function stateNames(flags) {
          ...
          var active = [];
          for (
            var _i = 0, _stateEntries_1 = _stateEntries;
            _i < _stateEntries_1.length;
            _i++
          ) {
            var _a = _stateEntries_1[_i],
              name_2 = _a[0],
              bit = _a[1];
            if (flags & bit) active.push(name_2);
          }
        ...
        function traitNames(flags) {
          ...
          var active = [];
          for (
            var _i = 0, _traitEntries_1 = _traitEntries;
            _i < _traitEntries_1.length;
            _i++
          ) {
            var _a = _traitEntries_1[_i],
              name_3 = _a[0],
              bit = _a[1];
            if (flags & bit) active.push(name_3);
          }
          return active.join(", ") || "none";
        }
      ...
      /***/ (
        ...
        var AccessibilityOverlay = /** @class */ (function () {
          function AccessibilityOverlay(options) {
            ...
            this.allowFocusInterrupt =
              (_a = options.allowFocusInterrupt) !== null && _a !== void 0
                ? _a
                : false;
            this.container = this.createContainer(options.canvas);
            this.attachPositionObservers();
          }
          AccessibilityOverlay.prototype.getSemanticOverlayContainer =
            function () {
          ...
          AccessibilityOverlay.prototype.observePosition = function () {
            ...
            (_a = this.positionObserver) === null || _a === void 0
              ? void 0
              : _a.disconnect();
            this.positionObserver = null;
          ...
          AccessibilityOverlay.prototype.createContainer = function (canvas) {
            ...
            container.setAttribute(
              "aria-label",
              (_b =
                (_a = this.semanticsOptions) === null || _a === void 0
                  ? void 0
                  : _a.riveCanvasLabel) !== null && _b !== void 0
                ? _b
                : "Rive animation",
            );
          ...
          AccessibilityOverlay.prototype.needsUpdate = function (tree) {
            var semanticChanged =
              tree.semanticVersion !== this.lastSemanticVersion;
            var nodeGeometryChanged =
            ...
            return {
              ...
              nodeGeometryChanged: nodeGeometryChanged,
           ...
           */
          AccessibilityOverlay.prototype.update = function (
            tree,
            forwardMat,
            dpr,
            artboardBounds,
          ...
          AccessibilityOverlay.prototype.performUpdate = function (
            tree,
            forwardMat,
            dpr,
            artboardBounds,
            ...
            var _a;
            var semanticChanged = change.semanticChanged,
              nodeGeometryChanged = change.nodeGeometryChanged;
            ...
            if (semanticChanged) {
              var rootEl =
                (_a = this.transformContainer) !== null && _a !== void 0
                  ? _a
                  : this.container;
              ...
              this.elements.forEach(function (_el, id) {
                if (!activeIds_1.has(id)) staleIds_2.push(id);
              });
              for (
                var _i = 0, staleIds_1 = staleIds_2;
                _i < staleIds_1.length;
                _i++
              ) {
          ...
          AccessibilityOverlay.prototype.destroy = function () {
            ...
            (_a = this.canvasResizeObserver) === null || _a === void 0
              ? void 0
              : _a.disconnect();
            (_b = this.parentResizeObserver) === null || _b === void 0
              ? void 0
              : _b.disconnect();
            (_c = this.positionObserver) === null || _c === void 0
              ? void 0
              : _c.disconnect();
           ...
           */
          AccessibilityOverlay.prototype.rebuildChildren = function (
            parentEl,
            childIds,
            tree,
            parentArtboardLeft,
            ...
            for (var i = 0; i < childIds.length; i++) {
              ...
              if (
                isNew ||
                applyAllAttributes ||
                tree.semanticChangedIds.has(nodeId)
              ) {
              ...
              if (
                (0, _types__WEBPACK_IMPORTED_MODULE_0__.hasTrait)(
                  nodeData.traitFlags,
                  _types__WEBPACK_IMPORTED_MODULE_0__.SemanticTrait.Focusable,
                ) &&
                (0, _types__WEBPACK_IMPORTED_MODULE_0__.hasState)(
                  nodeData.stateFlags,
                  _types__WEBPACK_IMPORTED_MODULE_0__.SemanticState.Focused,
                )
              ) {
           ...
           */
          AccessibilityOverlay.prototype.updateGeometryForChangedNodes =
            function (tree) {
              var _a, _b;
              for (
                var _i = 0, _c = Array.from(tree.geometryChangedIds);
                _i < _c.length;
                _i++
              ) {
                var nodeId = _c[_i];
                ...
                if (nodeData.parentId >= 0) {
                  ...
                  if (parent_1) {
                    ...
                    parentEl =
                      (_b = this.elements.get(nodeData.parentId)) !== null &&
                      _b !== void 0
                        ? _b
                        : parentEl;
                  }
          ...
          AccessibilityOverlay.prototype.updateNodeGeometrySubtree = function (
            tree,
            nodeId,
            parentArtboardLeft,
            parentArtboardTop,
           ...
           */
          AccessibilityOverlay.prototype.autoFocusDialogOnAppear = function (
            el,
            node,
            tree,
          ) {
            ...
            var target =
              (_a = this.routeDefaultFocusTarget(node, tree)) !== null &&
              _a !== void 0
                ? _a
                : el;
           ...
           */
          AccessibilityOverlay.prototype.routeDefaultFocusTarget = function (
            node,
            tree,
          ) {
            var _a;
            for (var _i = 0, _b = node.children; _i < _b.length; _i++) {
              ...
              if (childEl) {
                return (_a = childEl.querySelector(":scope > span")) !== null &&
                  _a !== void 0
                  ? _a
                  : childEl;
              }
          ...
          Object.defineProperty(
            AccessibilityOverlay.prototype,
            "nodeIdPrefix",
            {
              // ---- Element creation ----
          ...
          AccessibilityOverlay.prototype.createElement = function (node) {
            ...
            if (
              node.role ===
              _types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.text
            ) {
            ...
            el.addEventListener("keydown", function (e) {
              ...
              if (next && next !== el) {
                ...
                if (nextId !== null)
                  _this.fireAction(
                    nextId,
                    _types__WEBPACK_IMPORTED_MODULE_0__.SemanticActionType.tap,
                  );
              }
            });
          };
          AccessibilityOverlay.prototype.attachActionHandlers = function (
            el,
            node,
          ) {
            var _this = this;
            ...
            if (isClickableRole(role)) {
              ...
              var activationKeys_1 =
                role === _types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.link
                  ? ["Enter"]
                  : ["Enter", " "];
              el.addEventListener("keydown", function (e) {
            ...
            if (
              role === _types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.slider
            ) {
              el.addEventListener("keydown", function (e) {
                if (e.key === "ArrowRight" || e.key === "ArrowUp") {
                  ...
                  _this.fireAction(
                    nodeId,
                    _types__WEBPACK_IMPORTED_MODULE_0__.SemanticActionType
                      .increase,
                  );
            ...
            if (
              ...
              this.attachRovingNav(el, {
                ...
                members: function () {
                  var _a;
                  var group =
                    (_a = el.closest('[role="radiogroup"]')) !== null &&
                    _a !== void 0
                      ? _a
                      : el.parentElement;
                  if (!group) return [];
          ...
          AccessibilityOverlay.prototype.applyAttributes = function (el, node) {
            ...
            if (
              ...
              setBoolAttr(
                ...
                (0, _types__WEBPACK_IMPORTED_MODULE_0__.hasState)(
                  flags,
                  _types__WEBPACK_IMPORTED_MODULE_0__.SemanticState.ReadOnly,
                ),
              );
            } else {
              removeAttr(el, "aria-valuenow");
            ...
            if (
              role === _types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.text
            ) {
              var textSpan =
                (_a = el.querySelector(":scope > span")) !== null &&
                _a !== void 0
                  ? _a
                  : el;
            ...
            if (
              (0, _types__WEBPACK_IMPORTED_MODULE_0__.hasTrait)(
                traits,
                _types__WEBPACK_IMPORTED_MODULE_0__.SemanticTrait.Expandable,
              ) &&
              ARIA_EXPANDED_ROLES.has(role)
            ) {
              setBoolAttr(
                el,
                "aria-expanded",
                (0, _types__WEBPACK_IMPORTED_MODULE_0__.hasState)(
                  flags,
                  _types__WEBPACK_IMPORTED_MODULE_0__.SemanticState.Expanded,
                ),
              );
            } else {
            ...
            if (role === _types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.tab) {
              setBoolAttr(
                ...
                (0, _types__WEBPACK_IMPORTED_MODULE_0__.hasState)(
                  flags,
                  _types__WEBPACK_IMPORTED_MODULE_0__.SemanticState.Selected,
                ),
              );
            } else if (
              (0, _types__WEBPACK_IMPORTED_MODULE_0__.hasTrait)(
                traits,
                _types__WEBPACK_IMPORTED_MODULE_0__.SemanticTrait.Selectable,
              ) &&
              ARIA_SELECTED_ROLES.has(role)
            ) {
              setBoolAttr(
                el,
                "aria-selected",
            ...
            if (
              (0, _types__WEBPACK_IMPORTED_MODULE_0__.hasTrait)(
                traits,
                _types__WEBPACK_IMPORTED_MODULE_0__.SemanticTrait.Checkable,
              ) &&
              ARIA_CHECKED_ROLES.has(role)
            ) {
              ...
              if (
                (0, _types__WEBPACK_IMPORTED_MODULE_0__.hasState)(
                  flags,
                  _types__WEBPACK_IMPORTED_MODULE_0__.SemanticState.Mixed,
                ) &&
                role !==
                ...
                setBoolAttr(
                  ...
                  (0, _types__WEBPACK_IMPORTED_MODULE_0__.hasState)(
                    flags,
                    _types__WEBPACK_IMPORTED_MODULE_0__.SemanticState.Checked,
                  ),
                );
              }
            } else {
            ...
            if (
              (0, _types__WEBPACK_IMPORTED_MODULE_0__.hasTrait)(
                traits,
                _types__WEBPACK_IMPORTED_MODULE_0__.SemanticTrait.Toggleable,
              )
            ) {
              if (ARIA_PRESSED_ROLES.has(role)) {
                setBoolAttr(
                  ...
                  (0, _types__WEBPACK_IMPORTED_MODULE_0__.hasState)(
                    flags,
                    _types__WEBPACK_IMPORTED_MODULE_0__.SemanticState.Toggled,
                  ),
                );
              } else {
            ...
            if (
              (0, _types__WEBPACK_IMPORTED_MODULE_0__.hasTrait)(
                traits,
                _types__WEBPACK_IMPORTED_MODULE_0__.SemanticTrait.Requirable,
              ) &&
              ARIA_REQUIRED_ROLES.has(role)
            ) {
              setBoolAttr(
                el,
                "aria-required",
                (0, _types__WEBPACK_IMPORTED_MODULE_0__.hasState)(
                  flags,
                  _types__WEBPACK_IMPORTED_MODULE_0__.SemanticState.Required,
                ),
              );
            } else {
            ...
            if (
              (0, _types__WEBPACK_IMPORTED_MODULE_0__.hasTrait)(
                traits,
                _types__WEBPACK_IMPORTED_MODULE_0__.SemanticTrait.Enablable,
              )
            ) {
              setBoolAttr(
                el,
                ...
                (0, _types__WEBPACK_IMPORTED_MODULE_0__.hasState)(
                  flags,
                  _types__WEBPACK_IMPORTED_MODULE_0__.SemanticState.Disabled,
                ),
              );
            } else {
            ...
            // decorative instead.
            var isDecorativeImage =
              role === _types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.image &&
              !node.label;
            if (
              (0, _types__WEBPACK_IMPORTED_MODULE_0__.hasState)(
                flags,
                _types__WEBPACK_IMPORTED_MODULE_0__.SemanticState.Hidden,
              ) ||
              (0, _types__WEBPACK_IMPORTED_MODULE_0__.hasState)(
                flags,
                _types__WEBPACK_IMPORTED_MODULE_0__.SemanticState.Obscured,
              ) ||
              isDecorativeImage
            ) {
            ...
            if (
              (0, _types__WEBPACK_IMPORTED_MODULE_0__.hasState)(
                flags,
                _types__WEBPACK_IMPORTED_MODULE_0__.SemanticState.LiveRegion,
              )
            ) {
            ...
            if (
              ...
              setBoolAttr(
                ...
                (0, _types__WEBPACK_IMPORTED_MODULE_0__.hasState)(
                  flags,
                  _types__WEBPACK_IMPORTED_MODULE_0__.SemanticState.Multiline,
                ),
              );
              ...
              if (node.children.length === 0) {
                var value =
                  (_c = node.value) !== null && _c !== void 0 ? _c : "";
           ...
           */
          AccessibilityOverlay.prototype.applyPosition = function (
            el,
            node,
            parentArtboardLeft,
            parentArtboardTop,
          ...
          AccessibilityOverlay.prototype.flushTextGeometry = function () {
            ...
            var toMeasure = [];
            for (
              var _i = 0, _b = this.pendingTextGeometry;
              _i < _b.length;
              _i++
            ) {
              var host = _b[_i];
              var span =
                (_a = host.querySelector(":scope > span")) !== null &&
                _a !== void 0
                  ? _a
                  : host;
              var key = ""
                .concat(host.style.width, "|")
                .concat(host.style.height, "|")
                .concat(span.textContent);
           ...
           */
          AccessibilityOverlay.prototype.syncTransformContainer = function (
            forwardMat,
            dpr,
            artboardBounds,
          ) {
        ...
        function isModalDialogRole(role, flags) {
          return (
            role ===
              _types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.alertDialog ||
            (role === _types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.dialog &&
              (0, _types__WEBPACK_IMPORTED_MODULE_0__.hasState)(
                flags,
                _types__WEBPACK_IMPORTED_MODULE_0__.SemanticState.Modal,
              ))
          );
        }
      ...
      /***/ (
        ...
        __webpack_require__.r(__webpack_exports__);
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ AudioAssetWrapper: () =>
            /* reexport safe */ _finalizationRegistry__WEBPACK_IMPORTED_MODULE_3__.AudioAssetWrapper,
          /* harmony export */ AudioWrapper: () =>
            /* reexport safe */ _finalizationRegistry__WEBPACK_IMPORTED_MODULE_3__.AudioWrapper,
          /* harmony export */ BLANK_URL: () =>
            /* reexport safe */ _sanitizeUrl__WEBPACK_IMPORTED_MODULE_2__.BLANK_URL,
          /* harmony export */ CustomFileAssetLoaderWrapper: () =>
            /* reexport safe */ _finalizationRegistry__WEBPACK_IMPORTED_MODULE_3__.CustomFileAssetLoaderWrapper,
          /* harmony export */ FileAssetWrapper: () =>
            /* reexport safe */ _finalizationRegistry__WEBPACK_IMPORTED_MODULE_3__.FileAssetWrapper,
          /* harmony export */ FileFinalizer: () =>
            /* reexport safe */ _finalizationRegistry__WEBPACK_IMPORTED_MODULE_3__.FileFinalizer,
          /* harmony export */ FocusSessionState: () =>
            /* reexport safe */ _registerKeyboardInteractions__WEBPACK_IMPORTED_MODULE_1__.FocusSessionState,
          /* harmony export */ FontAssetWrapper: () =>
            /* reexport safe */ _finalizationRegistry__WEBPACK_IMPORTED_MODULE_3__.FontAssetWrapper,
          /* harmony export */ FontWrapper: () =>
            /* reexport safe */ _finalizationRegistry__WEBPACK_IMPORTED_MODULE_3__.FontWrapper,
          /* harmony export */ ImageAssetWrapper: () =>
            /* reexport safe */ _finalizationRegistry__WEBPACK_IMPORTED_MODULE_3__.ImageAssetWrapper,
          /* harmony export */ ImageWrapper: () =>
            /* reexport safe */ _finalizationRegistry__WEBPACK_IMPORTED_MODULE_3__.ImageWrapper,
          /* harmony export */ KeyboardInteractions: () =>
            /* reexport safe */ _registerKeyboardInteractions__WEBPACK_IMPORTED_MODULE_1__.KeyboardInteractions,
          /* harmony export */ RiveFont: () =>
            /* reexport safe */ _riveFont__WEBPACK_IMPORTED_MODULE_4__.RiveFont,
          /* harmony export */ createFinalization: () =>
            /* reexport safe */ _finalizationRegistry__WEBPACK_IMPORTED_MODULE_3__.createFinalization,
          /* harmony export */ finalizationRegistry: () =>
            /* reexport safe */ _finalizationRegistry__WEBPACK_IMPORTED_MODULE_3__.finalizationRegistry,
          /* harmony export */ registerTouchInteractions: () =>
            /* reexport safe */ _registerTouchInteractions__WEBPACK_IMPORTED_MODULE_0__.registerTouchInteractions,
          /* harmony export */ sanitizeUrl: () =>
            /* reexport safe */ _sanitizeUrl__WEBPACK_IMPORTED_MODULE_2__.sanitizeUrl,
          /* harmony export */
        });
        /* harmony import */ var _registerTouchInteractions__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(11);
        /* harmony import */ var _registerKeyboardInteractions__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(12);
        /* harmony import */ var _sanitizeUrl__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(13);
        /* harmony import */ var _finalizationRegistry__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__(14);
        /* harmony import */ var _riveFont__WEBPACK_IMPORTED_MODULE_4__ =
      ...
      /***/ (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ registerTouchInteractions: () =>
            /* binding */ registerTouchInteractions,
          /* harmony export */
        });
        var _this = undefined;
        /**
         ...
         */
        var getTouchCoordinates = function (
          changedTouches,
          enableMultiTouch,
          primaryTouchId,
        ) {
          ...
          if (enableMultiTouch) {
            ...
            var primaryTouch =
              primaryTouchId !== null
                ? (_a = Array.from(changedTouches).find(function (t) {
         ...
         */
        var getClientCoordinates = function (
          event,
          ...
          if (
            (_a = touchEvent.changedTouches) === null || _a === void 0
              ? void 0
              : _a.length
          ) {
        ...
        var registerTouchInteractions = function (_a) {
          var canvas = _a.canvas,
            ...
            _d = _a.dispatchPointerExit,
            dispatchPointerExit = _d === void 0 ? true : _d,
            _e = _a.enableMultiTouch,
            enableMultiTouch = _e === void 0 ? false : _e,
            _f = _a.layoutScaleFactor,
            layoutScaleFactor = _f === void 0 ? 1.0 : _f,
            advanceAndDrain = _a.advanceAndDrain;
          if (
            !canvas ||
          ...
          var processEventCallback = function (event) {
            ...
            var coordinateSets = getClientCoordinates(
              event,
              isTouchScrollEnabled,
              enableMultiTouch,
              enableMultiTouch ? null : _primaryTouchId,
            );
            var forwardMatrix = rive.computeAlignment(
              fit,
              alignment,
              {
                minX: 0,
            ...
            coordinateSets.forEach(function (coordinateSet) {
              ...
              var transformedVector = rive.mapXY(
                invertedMatrix,
            ...
            switch (event.type) {
              ...
              case "mouseout":
                ...
                for (
                  var _i = 0, stateMachines_1 = stateMachines;
                  _i < stateMachines_1.length;
                  _i++
                ) {
              ...
              case "mousemove": {
                ...
                for (
                  var _b = 0, stateMachines_2 = stateMachines;
                  _b < stateMachines_2.length;
                  _b++
                ) {
              ...
              case "mousedown": {
                ...
                for (
                  var _c = 0, stateMachines_3 = stateMachines;
                  _c < stateMachines_3.length;
                  _c++
                ) {
              ...
              case "touchend": {
                ...
                for (
                  var _d = 0, stateMachines_4 = stateMachines;
                  _d < stateMachines_4.length;
                  _d++
                ) {
                ...
                if (
                  !enableMultiTouch &&
                  coordinateSets.some(function (c) {
              ...
              case "mouseup": {
                ...
                for (
                  var _e = 0, stateMachines_5 = stateMachines;
                  _e < stateMachines_5.length;
                  _e++
                ) {
      ...
      /***/ (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ FocusSessionState: () =>
            /* binding */ FocusSessionState,
          /* harmony export */ KeyboardInteractions: () =>
            /* binding */ KeyboardInteractions,
          /* harmony export */
        });
        /**
        ...
        var KeyboardInteractions = /** @class */ (function () {
          function KeyboardInteractions(_a) {
            var canvas = _a.canvas,
              stateMachine = _a.stateMachine,
              hasFocusNodes = _a.hasFocusNodes,
              getOverlayElement = _a.getOverlayElement;
            var _this = this;
            var _b;
            ...
            this.onCanvasFocus = function (event) {
              ...
              if (
                forward
                  ? _this.mainSm.focusNext()
                  : _this.mainSm.focusPrevious()
              ) {
            ...
            this.onCanvasBlur = function (event) {
              ...
              var movedWithinFocusDomain = _this.isInFocusDomain(
                event.relatedTarget,
              );
              var documentLostFocus =
            ...
            this.onOverlayFocusIn = function (event) {
              if (!_this.isInOverlay(event.target)) return;
              _this.focusDomainReleased = false;
              if (!_this.hasFocusNodes) return;
            ...
            this.onKeyDown = function (event) {
              ...
              if (_this.focusDomainReleased) return;
              if (!_this.shouldRiveHandleKeyEvent(event)) return;
              if (event.code === "Tab" && _this.hasFocusNodes) {
                var forward = !event.shiftKey;
                var focusMoved = forward
                  ? _this.mainSm.focusNext()
                  : _this.mainSm.focusPrevious();
                if (focusMoved) {
            ...
            this.focusDomainHost =
              (_b = canvas.parentElement) !== null && _b !== void 0
                ? _b
                : document;
           ...
           */
          KeyboardInteractions.prototype.setFocusSessionState = function (
            state,
          ) {
           ...
           */
          KeyboardInteractions.prototype.shouldRiveHandleKeyEvent = function (
            event,
          ) {
          ...
          KeyboardInteractions.prototype.isInOverlay = function (target) {
            ...
            return (_c =
              (_b =
                (_a = this.getOverlayElement) === null || _a === void 0
                  ? void 0
                  : _a.call(this)) === null || _b === void 0
                ? void 0
                : _b.contains(target)) !== null && _c !== void 0
              ? _c
              : false;
          };
          KeyboardInteractions.prototype.syncOverlayListener = function () {
            var _a, _b, _c, _d, _e, _f;
            var nextOverlayElement =
              (_b =
                (_a = this.getOverlayElement) === null || _a === void 0
                  ? void 0
                  : _a.call(this)) !== null && _b !== void 0
            ...
            (_c = this.currentOverlayElement) === null || _c === void 0
              ? void 0
              : _c.removeEventListener("focusin", this.onOverlayFocusIn);
            (_d = this.currentOverlayElement) === null || _d === void 0
              ? void 0
              : _d.removeEventListener("keydown", this.onKeyDown, true);
            this.currentOverlayElement = nextOverlayElement;
            (_e = this.currentOverlayElement) === null || _e === void 0
              ? void 0
              : _e.addEventListener("focusin", this.onOverlayFocusIn);
            (_f = this.currentOverlayElement) === null || _f === void 0
              ? void 0
              : _f.addEventListener("keydown", this.onKeyDown, true);
          };
          /**
          ...
          KeyboardInteractions.prototype.cameFromBeforeCanvas = function (
            from,
          ) {
            if (!from) return true;
          ...
          KeyboardInteractions.prototype.cleanup = function () {
            ...
            (_a = this.currentOverlayElement) === null || _a === void 0
              ? void 0
              : _a.removeEventListener("focusin", this.onOverlayFocusIn);
            (_b = this.currentOverlayElement) === null || _b === void 0
              ? void 0
              : _b.removeEventListener("keydown", this.onKeyDown, true);
          };
      ...
      /***/ (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ AudioAssetWrapper: () =>
            /* binding */ AudioAssetWrapper,
          /* harmony export */ AudioWrapper: () => /* binding */ AudioWrapper,
          /* harmony export */ CustomFileAssetLoaderWrapper: () =>
            /* binding */ CustomFileAssetLoaderWrapper,
          /* harmony export */ FileAssetWrapper: () =>
            /* binding */ FileAssetWrapper,
          /* harmony export */ FileFinalizer: () => /* binding */ FileFinalizer,
          /* harmony export */ FontAssetWrapper: () =>
            /* binding */ FontAssetWrapper,
          /* harmony export */ FontWrapper: () => /* binding */ FontWrapper,
          /* harmony export */ ImageAssetWrapper: () =>
            /* binding */ ImageAssetWrapper,
          /* harmony export */ ImageWrapper: () => /* binding */ ImageWrapper,
          /* harmony export */ createFinalization: () =>
            /* binding */ createFinalization,
          /* harmony export */ finalizationRegistry: () =>
        ...
        var CustomFileAssetLoaderWrapper = /** @class */ (function () {
          ...
          CustomFileAssetLoaderWrapper.prototype.loadContents = function (
            asset,
            bytes,
          ) {
            var assetWrapper;
      ...
      /***/ (
        ...
        /* harmony import */ var _runtimeLoader__WEBPACK_IMPORTED_MODULE_0__ =
        ...
        var RiveFont = /** @class */ (function () {
          ...
          RiveFont.setFallbackFontCallback = function (fontCallback) {
            RiveFont._fallbackFontCallback =
              fontCallback !== null && fontCallback !== void 0
                ? fontCallback
                : null;
          ...
          RiveFont._fontToPtr = function (fontWrapper) {
            ...
            var ptr =
              (_a =
                embindFont === null || embindFont === void 0
                  ? void 0
                  : embindFont.ptr) === null || _a === void 0
                ? void 0
                : _a.call(embindFont);
          ...
          RiveFont._wireFallbackProc = function () {
            _runtimeLoader__WEBPACK_IMPORTED_MODULE_0__.RuntimeLoader.getInstance(
              function (rive) {
                var cb = RiveFont._fallbackFontCallback;
                if (cb) {
                  rive.setFallbackFontCallback(
                    function (missingGlyph, fallbackFontIndex, weight) {
                      ...
                      if (fontsReturned) {
                        ...
                        return fallbackFontIndex === 0
                          ? RiveFont._fontToPtr(fontsReturned)
                          : null;
                      }
                      return null;
                    },
    ...
    (() => {
      ...
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        ...
        /* harmony export */ DrawOptimizationOptions: () =>
          /* binding */ DrawOptimizationOptions,
        ...
        /* harmony export */ RiveFont: () =>
          /* reexport safe */ _utils__WEBPACK_IMPORTED_MODULE_3__.RiveFont,
        /* harmony export */ RuntimeLoader: () =>
          /* reexport safe */ _runtimeLoader__WEBPACK_IMPORTED_MODULE_1__.RuntimeLoader,
        /* harmony export */ SemanticMode: () =>
          /* reexport safe */ _semantics__WEBPACK_IMPORTED_MODULE_2__.SemanticMode,
        /* harmony export */ StateMachineInput: () =>
          /* binding */ StateMachineInput,
        /* harmony export */ StateMachineInputType: () =>
          /* binding */ StateMachineInputType,
        /* harmony export */ Testing: () => /* binding */ Testing,
        /* harmony export */ ViewModel: () => /* binding */ ViewModel,
        /* harmony export */ ViewModelInstance: () =>
          /* binding */ ViewModelInstance,
        /* harmony export */ ViewModelInstanceArtboard: () =>
          /* binding */ ViewModelInstanceArtboard,
        /* harmony export */ ViewModelInstanceAssetFont: () =>
          /* binding */ ViewModelInstanceAssetFont,
        /* harmony export */ ViewModelInstanceAssetImage: () =>
        ...
        /* harmony export */ ViewModelInstanceColor: () =>
          /* binding */ ViewModelInstanceColor,
        /* harmony export */ ViewModelInstanceEnum: () =>
          /* binding */ ViewModelInstanceEnum,
        /* harmony export */ ViewModelInstanceList: () =>
          /* binding */ ViewModelInstanceList,
        /* harmony export */ ViewModelInstanceNumber: () =>
          /* binding */ ViewModelInstanceNumber,
        /* harmony export */ ViewModelInstanceString: () =>
          /* binding */ ViewModelInstanceString,
        /* harmony export */ ViewModelInstanceTrigger: () =>
          /* binding */ ViewModelInstanceTrigger,
        /* harmony export */ ViewModelInstanceValue: () =>
          /* binding */ ViewModelInstanceValue,
      ...
      /* harmony import */ var _runtimeLoader__WEBPACK_IMPORTED_MODULE_1__ =
        __webpack_require__(3);
      /* harmony import */ var _semantics__WEBPACK_IMPORTED_MODULE_2__ =
      ...
      var Layout = /** @class */ (function () {
        function Layout(params) {
          ...
          this.fit =
            (_a =
              params === null || params === void 0 ? void 0 : params.fit) !==
              null && _a !== void 0
              ? _a
              : Fit.Contain;
          this.alignment =
            (_b =
              params === null || params === void 0
                ? void 0
                : params.alignment) !== null && _b !== void 0
              ? _b
              : Alignment.Center;
          this.layoutScaleFactor =
            (_c =
              params === null || params === void 0
                ? void 0
                : params.layoutScaleFactor) !== null && _c !== void 0
              ? _c
              : 1;
          this.minX =
            (_d =
              params === null || params === void 0 ? void 0 : params.minX) !==
              null && _d !== void 0
              ? _d
              : 0;
          this.minY =
            (_e =
              params === null || params === void 0 ? void 0 : params.minY) !==
              null && _e !== void 0
              ? _e
              : 0;
          this.maxX =
            (_f =
              params === null || params === void 0 ? void 0 : params.maxX) !==
              null && _f !== void 0
              ? _f
              : 0;
          this.maxY =
            (_g =
              params === null || params === void 0 ? void 0 : params.maxY) !==
              null && _g !== void 0
              ? _g
              : 0;
        }
        ...
        Layout.prototype.copyWith = function (_a) {
          ...
          return new Layout({
            ...
            alignment:
              alignment !== null && alignment !== void 0
                ? alignment
                : this.alignment,
            layoutScaleFactor:
              layoutScaleFactor !== null && layoutScaleFactor !== void 0
                ? layoutScaleFactor
                : this.layoutScaleFactor,
      ...
      (function (StateMachineInputType) {
        StateMachineInputType[(StateMachineInputType["Number"] = 56)] =
          "Number";
        StateMachineInputType[(StateMachineInputType["Trigger"] = 58)] =
          "Trigger";
        StateMachineInputType[(StateMachineInputType["Boolean"] = 59)] =
          "Boolean";
      ...
      var BindableArtboard = /** @class */ (function (_super) {
        ...
        BindableArtboard.prototype.destroy = function () {
          ...
          if (this.selfUnref) {
            ...
            (_a = this.nativeViewModel) === null || _a === void 0
              ? void 0
              : _a.unref();
          }
        };
      ...
      var StateMachine = /** @class */ (function () {
        ...
        function StateMachine(stateMachine, runtime, playing, artboard) {
           ...
           */
          this.inputs = [];
          this.instance = new runtime.StateMachineInstance(
            stateMachine,
            artboard,
          );
         ...
         */
        StateMachine.prototype.fireSemanticAction = function (
          nodeId,
          actionType,
        ) {
        ...
        StateMachine.prototype.bindViewModelInstance = function (
          viewModelInstance,
        ) {
      ...
      var Animator = /** @class */ (function () {
         ...
         */
        Animator.prototype.add = function (
          animatables,
          playing,
          fireEvent,
          semanticsActive,
          ...
          if (animatables.length === 0) {
            ...
            for (var i = 0; i < animatables.length; i++) {
              ...
              if (aIndex >= 0 || mIndex >= 0) {
                ...
                if (anim) {
                  var newAnimation =
                    new _animation__WEBPACK_IMPORTED_MODULE_0__.Animation(
                      anim,
                      this.artboard,
                      this.runtime,
                      playing,
         ...
         */
        Animator.prototype.initLinearAnimations = function (
          animatables,
          playing,
          isFallingBackFromStateMachines,
        ) {
          ...
          for (var i = 0; i < animatables.length; i++) {
            ...
            if (aIndex >= 0) {
              ...
              if (anim) {
                ...
                // Throw LoadError if we cannot load the state machine name at all
                var smInitializationMessage = "State Machine with name ".concat(
                  animatables[i],
                  " not found",
                );
                ...
                console.error(
                  "Animation with name ".concat(animatables[i], " not found."),
                );
              }
            }
          }
         ...
         */
        Animator.prototype.initStateMachines = function (
          animatables,
          playing,
          semanticsActive,
        ) {
        ...
        Animator.prototype.stop = function (animatables) {
          ...
          if (animatables.length === 0) {
            removedNames = this.animations
              ...
              .concat(
                this.stateMachines.map(function (m) {
                  return m.name;
                }),
              );
            ...
            removedNames = animationsToRemove
              ...
              .concat(
                machinesToRemove.map(function (m) {
                  return m.name;
                }),
              );
          }
        ...
        Object.defineProperty(Animator.prototype, "isPlaying", {
          ...
          get: function () {
            return (
              this.animations.reduce(function (acc, curr) {
                return acc || curr.playing;
              }, false) ||
              this.stateMachines.reduce(function (acc, curr) {
                return acc || curr.playing;
              }, false)
            );
          },
        ...
        Animator.prototype.handleLooping = function () {
          for (
            var _i = 0,
              _a = this.animations.filter(function (a) {
                return a.playing;
              });
            _i < _a.length;
            _i++
        ...
        Animator.prototype.handleStateChanges = function () {
          ...
          for (
            var _i = 0,
              _a = this.stateMachines.filter(function (sm) {
                return sm.playing;
              });
            _i < _a.length;
            _i++
      ...
      (function (SystemAudioStatus) {
        ...
        SystemAudioStatus[(SystemAudioStatus["UNAVAILABLE"] = 1)] =
          "UNAVAILABLE";
            ...
            return __generator(this, function (_b) {
              switch (_b.label) {
                ...
                case 1:
                  ...
                  return [
                    4 /*yield*/,
                    Promise.race([this._audioContext.resume(), this.timeout()]),
                  ];
                case 2:
                  _b.sent();
                  this.enableAudio();
      ...
      var RiveFile = /** @class */ (function () {
            ...
            return __generator(this, function (_c) {
              switch (_c.label) {
                ...
                case 4:
                  ...
                  if (this.assetLoader) {
                    loaderWrapper =
                      new _utils__WEBPACK_IMPORTED_MODULE_3__.CustomFileAssetLoaderWrapper(
                        this.runtime,
                        this.assetLoader,
                      );
                ...
                case 5:
                  ...
                  fileFinalizer =
                    new _utils__WEBPACK_IMPORTED_MODULE_3__.FileFinalizer(
                      this.file,
                    );
                  _utils__WEBPACK_IMPORTED_MODULE_3__.finalizationRegistry.register(
                    this,
                    fileFinalizer,
                  );
                  if (this.destroyed) {
            ...
            return __generator(this, function (_b) {
              switch (_b.label) {
                ...
                case 1:
                  ...
                  return [
                    4 /*yield*/,
                    Promise.all([this.loadRiveFileBytes(), this.loadRuntime()]),
                  ];
                case 2:
                  ((_a = _b.sent()),
                    (bufferResolved = _a[0]),
                    (runtimeResolved = _a[1]));
                  if (this.destroyed) {
                    return [2 /*return*/];
                  }
        ...
        RiveFile.prototype.createBindableArtboard = function (
          nativeBindableArtboard,
        ) {
          if (nativeBindableArtboard != null) {
            var bindableArtboard = new BindableArtboard(nativeBindableArtboard);
            (0, _utils__WEBPACK_IMPORTED_MODULE_3__.createFinalization)(
              bindableArtboard,
              bindableArtboard.nativeArtboard,
            );
        ...
        RiveFile.prototype.internalBindableArtboardFromArtboard = function (
          artboard,
        ) {
          var nativeBindableArtboard =
      ...
      var Rive = /** @class */ (function () {
        function Rive(params) {
          ...
          this.enableRiveAssetCDN = true;
          this.semanticsMode =
            _semantics__WEBPACK_IMPORTED_MODULE_2__.SemanticMode.Disabled;
          ...
          this.layout =
            (_a = params.layout) !== null && _a !== void 0 ? _a : new Layout();
          ...
          this.drawOptimization =
            (_b = params.drawingOptions) !== null && _b !== void 0
              ? _b
              : this.drawOptimization;
          this.enableRiveAssetCDN =
          ...
          if (this.enablePerfMarks)
            _runtimeLoader__WEBPACK_IMPORTED_MODULE_1__.RuntimeLoader.enablePerfMarks = true;
          this._focusOptions =
            (_c = params.focusOptions) !== null && _c !== void 0
              ? _c
              : this._focusOptions;
          this._tabIndex =
            (_d = params.tabIndex) !== null && _d !== void 0 ? _d : null;
          // New event management system
          this.eventManager = new EventManager();
          if (params.onLoad) this.on(EventType.Load, params.onLoad);
          if (params.onLoadError)
        ...
        Rive.prototype.enableSemantics = function () {
          this.semanticsMode =
            _semantics__WEBPACK_IMPORTED_MODULE_2__.SemanticMode.Enabled;
        ...
        Rive.prototype.syncSemanticsOnStateMachines = function () {
          ...
          for (
            var _i = 0, _a = this.animator.stateMachines;
            _i < _a.length;
            _i++
          ) {
            var stateMachine = _a[_i];
        ...
        Rive.prototype.init = function (_a) {
          ...
          var src = _a.src,
            ...
            semanticsMode = _a.semanticsMode,
            semanticsOptions = _a.semanticsOptions;
          if (this.destroyed) {
            return;
          }
          this.src = src;
          ...
          this._tabIndex =
            tabIndex !== null && tabIndex !== void 0 ? tabIndex : null;
          this.semanticsMode =
            semanticsMode !== null && semanticsMode !== void 0
              ? semanticsMode
              : _semantics__WEBPACK_IMPORTED_MODULE_2__.SemanticMode.Disabled;
          this.semanticsOptions =
            semanticsOptions !== null && semanticsOptions !== void 0
              ? semanticsOptions
              : this.semanticsOptions;
          // If no source file url specified, it's a bust
          ...
          _runtimeLoader__WEBPACK_IMPORTED_MODULE_1__.RuntimeLoader.awaitInstance()
            .then(function (runtime) {
              ...
              try {
                _this.renderer = _this.runtime.makeRenderer(
                  _this.canvas,
        ...
        Rive.prototype.setupRiveListeners = function (riveListenerOptions) {
          ...
          if (!this.shouldDisableRiveListeners) {
            var playingStateMachines = this.animator.stateMachines.filter(
              function (sm) {
                return sm.playing;
              },
            );
            ...
            if (
              ...
              touchScrollEnabledOption =
                riveListenerOptions.isTouchScrollEnabled;
            }
            this.eventCleanup = (0,
            _utils__WEBPACK_IMPORTED_MODULE_3__.registerTouchInteractions)({
              canvas: this.canvas,
        ...
        Rive.prototype.ensureKeyboardInteractions = function () {
          ...
          var smWithFocusNodes = this.animator.stateMachines.find(
            function (sm) {
          ...
          this._keyboardInteractions =
            new _utils__WEBPACK_IMPORTED_MODULE_3__.KeyboardInteractions({
              canvas: this.canvas,
              ...
              getOverlayElement: function () {
                var _a, _b;
                return (_b =
                  (_a = _this._accessibilityOverlay) === null || _a === void 0
                    ? void 0
                    : _a.getSemanticOverlayContainer()) !== null &&
                  _b !== void 0
                  ? _b
                  : null;
              },
        ...
        Rive.prototype.initializeAudio = function () {
          ...
          if (audioManager.status == SystemAudioStatus.UNAVAILABLE) {
            if (
              this.file.hasAudio ||
              (((_a = this.artboard) === null || _a === void 0
                ? void 0
                : _a.hasAudio) &&
                this._audioEventListener === null)
            ) {
        ...
        Rive.prototype.initArtboard = function (
          ...
          if (animationNames.length > 0 || stateMachineNames.length > 0) {
            ...
            instanceNames = [
              this.animator.atLeastOne(autoplay, false, this._semanticsActive),
            ];
          }
          ...
          if (autoBind) {
            ...
            if (viewModel !== null) {
              ...
              if (runtimeInstance !== null) {
                var viewModelInstance = new ViewModelInstance(
                  runtimeInstance,
                  null,
                );
                (0, _utils__WEBPACK_IMPORTED_MODULE_3__.createFinalization)(
            ...
            for (
              var _i = 0, _a = this.file.globalViewModelNames();
              _i < _a.length;
              _i++
            ) {
              var name_1 = _a[_i];
          ...
          if (
            (_a =
              document === null || document === void 0
                ? void 0
                : document.timeline) === null || _a === void 0
              ? void 0
              : _a.currentTime
          ) {
            if (this.loaded && this.artboard && !this.frameRequestId) {
              this._boundDraw(document.timeline.currentTime);
              (_b = this.runtime) === null || _b === void 0
                ? void 0
                : _b.resolveAnimationFrame();
            }
          } else {
          ...
          if (this.canvas instanceof HTMLCanvasElement) {
            ...
            if (hasFocus) {
              ...
              if (!this._prevHasFocus) {
                ...
                // to hold DOM focus.
                var scope =
                  (_a = this._accessibilityOverlay) === null || _a === void 0
                    ? void 0
                    : _a.getSemanticOverlayContainer();
                var focusAlreadyInScope =
                  document.activeElement === this.canvas ||
                  ((_b =
                    scope === null || scope === void 0
                      ? void 0
                      : scope.contains(document.activeElement)) !== null &&
                  _b !== void 0
                    ? _b
                    : false);
                if (
            ...
            if (
              ...
              _utils__WEBPACK_IMPORTED_MODULE_3__.FocusSessionState.RiveFocused
            ) {
              this._keyboardInteractions.setFocusSessionState(
                _utils__WEBPACK_IMPORTED_MODULE_3__.FocusSessionState
                  .NotFocused,
              );
            }
          }
        ...
        Rive.prototype.advanceAndReportChanges = function (elapsedTime) {
          ...
          for (
            var _i = 0, activeAnimations_1 = activeAnimations;
            _i < activeAnimations_1.length;
            _i++
          ) {
          ...
          // - Advance to the first frame even when autoplay is false
          var activeStateMachines = this.animator.stateMachines.filter(
            function (a) {
              return a.playing;
            },
          );
          ...
          for (
            var _c = 0, activeStateMachines_1 = activeStateMachines;
            _c < activeStateMachines_1.length;
            _c++
          ) {
                  ...
                  if (event_1.type === RiveEventType.OpenUrl) {
                    ...
                    if (this.automaticallyHandleEvents) {
                      ...
                      var _d = event_1,
                        ...
                        target = _d.target;
                      var sanitizedUrl = (0,
                      _utils__WEBPACK_IMPORTED_MODULE_3__.sanitizeUrl)(url);
                      url && newAnchorTag.setAttribute("href", sanitizedUrl);
                      target && newAnchorTag.setAttribute("target", target);
                      if (
                        sanitizedUrl &&
                        sanitizedUrl !==
                          _utils__WEBPACK_IMPORTED_MODULE_3__.BLANK_URL
                      ) {
                        newAnchorTag.click();
                      }
                    }
            ...
            if (_perfFrame >= 0) {
              ...
              performance.measure(
                "rive:sm-advance:f".concat(_perfFrame),
                "rive:sm-advance:start:f".concat(_perfFrame),
                "rive:sm-advance:end:f".concat(_perfFrame),
              );
            }
            if (this._semanticsActive) {
              ...
              if (diff) {
                if (!this._semanticTree) {
                  this._semanticTree =
                    new _semantics__WEBPACK_IMPORTED_MODULE_2__.SemanticTreeModel();
                }
          ...
          if (
            ...
            if (!this._accessibilityOverlay) {
              ...
              this._accessibilityOverlay =
                new _semantics__WEBPACK_IMPORTED_MODULE_2__.AccessibilityOverlay(
                  {
                    canvas: this.canvas,
            ...
            var overlayChange =
              (_a = this._accessibilityOverlay) === null || _a === void 0
                ? void 0
                : _a.needsUpdate(this._semanticTree);
            if (overlayChange || this._overlayTransformDirty) {
              ...
              var forwardMat = null;
              if (
                (overlayChange === null || overlayChange === void 0
                  ? void 0
                  : overlayChange.layoutChanged) ||
                this._overlayTransformDirty
              ) {
              ...
              forwardMat === null || forwardMat === void 0
                ? void 0
                : forwardMat.delete();
            }
          }
          ...
          (_b = this._viewModelInstance) === null || _b === void 0
            ? void 0
            : _b.handleCallbacks();
        ...
        Rive.prototype.draw = function (time, onSecond) {
          ...
          if (!this._hasZeroSize) {
            ...
            if (
              ...
              if (_perfFrame >= 0)
                performance.mark(
                  "rive:align-renderer:start:f".concat(_perfFrame),
                );
              this.alignRenderer();
              if (_perfFrame >= 0) {
                performance.mark(
                  "rive:align-renderer:end:f".concat(_perfFrame),
                );
                performance.measure(
                  "rive:align-renderer:f".concat(_perfFrame),
                  "rive:align-renderer:start:f".concat(_perfFrame),
                  "rive:align-renderer:end:f".concat(_perfFrame),
                );
              }
              if (_perfFrame >= 0)
                performance.mark(
                  "rive:artboard-draw:start:f".concat(_perfFrame),
                );
              this.artboard.draw(renderer);
              if (_perfFrame >= 0) {
                performance.mark("rive:artboard-draw:end:f".concat(_perfFrame));
                performance.measure(
                  "rive:artboard-draw:f".concat(_perfFrame),
                  "rive:artboard-draw:start:f".concat(_perfFrame),
                  "rive:artboard-draw:end:f".concat(_perfFrame),
                );
              }
              renderer.restore();
              if (_perfFrame >= 0)
                performance.mark(
                  "rive:renderer-flush:start:f".concat(_perfFrame),
                );
              renderer.flush();
              if (_perfFrame >= 0) {
                performance.mark(
                  "rive:renderer-flush:end:f".concat(_perfFrame),
                );
                performance.measure(
                  "rive:renderer-flush:f".concat(_perfFrame),
                  "rive:renderer-flush:start:f".concat(_perfFrame),
                  "rive:renderer-flush:end:f".concat(_perfFrame),
                );
              }
        ...
        Object.defineProperty(Rive.prototype, "frameTime", {
          get: function () {
            ...
            return (
              this.durations.reduce(function (a, b) {
                return a + b;
        ...
        Rive.prototype.cleanup = function () {
          ...
          // canvas2d build
          (_b =
            (_a = this.renderer) === null || _a === void 0
              ? void 0
              : _a.bindContext) === null || _b === void 0
            ? void 0
            : _b.call(_a);
          ...
          if (this.file) {
            (_c = this.riveFile) === null || _c === void 0
              ? void 0
              : _c.cleanup();
            this.file = null;
          }
          ...
          (_d = this._viewModelInstance) === null || _d === void 0
            ? void 0
            : _d.cleanup();
          this._viewModelInstance = null;
          this._globalViewModelInstances.forEach(function (instance) {
        ...
        Rive.prototype.reset = function (params) {
          ...
          var artBoardName =
            params === null || params === void 0 ? void 0 : params.artboard;
          var animationNames = mapToStringArray(
            params === null || params === void 0 ? void 0 : params.animations,
          );
          var stateMachineNames = mapToStringArray(
            params === null || params === void 0
              ? void 0
          ...
          var autoplay =
            (_a =
              params === null || params === void 0
                ? void 0
                : params.autoplay) !== null && _a !== void 0
              ? _a
              : false;
          var autoBind =
            (_b =
              params === null || params === void 0
                ? void 0
                : params.autoBind) !== null && _b !== void 0
              ? _b
              : false;
        ...
        Rive.prototype.stateMachineInputs = function (name) {
          ...
          return stateMachine === null || stateMachine === void 0
            ? void 0
            : stateMachine.inputs;
        };
          ...
          if (!this.artboard) {
            console.warn(
              "Tried to access input: '"
                .concat(name, "', at path: '")
                .concat(path, "', but the Artboard is null"),
            );
            return;
          }
         ...
         */
        Rive.prototype.setBooleanStateAtPath = function (
          inputName,
          value,
          path,
        ) {
          ...
          if (input.type === StateMachineInputType.Boolean) {
            ...
            console.warn(
              "Input with name: '"
                .concat(inputName, "', at path:'")
                .concat(path, "' is not a boolean"),
            );
          }
        };
        /**
         ...
         * @param path the path the input is located at an artboard level
         */
        Rive.prototype.setNumberStateAtPath = function (
          inputName,
          value,
          path,
        ) {
         ...
         * If the text run cannot be found at the specified path, a warning will be logged to the console.
         */
        Rive.prototype.setTextRunValueAtPath = function (
          textName,
          value,
          path,
        ) {
        ...
        Object.defineProperty(Rive.prototype, "isStopped", {
          ...
          get: function () {
            var _a, _b;
            return (_b =
              (_a = this.animator) === null || _a === void 0
                ? void 0
                : _a.isStopped) !== null && _b !== void 0
              ? _b
              : true;
          },
          enumerable: false,
        ...
        Rive.prototype._onPageVisibilityChange = function () {
          ...
          if (document.hidden) {
            if (this.frameRequestId !== null) {
              if (
                (_a = this.runtime) === null || _a === void 0
                  ? void 0
                  : _a.cancelAnimationFrame
              ) {
                this.runtime.cancelAnimationFrame(this.frameRequestId);
              } else {
                cancelAnimationFrame(this.frameRequestId);
            ...
            ((_b = this.animator) === null || _b === void 0
              ? void 0
              : _b.isPlaying) &&
          ...
          get: function () {
            ...
            for (var i = 0; i < this.file.artboardCount(); i++) {
              ...
              for (var k = 0; k < artboard.stateMachineCount(); k++) {
                ...
                var instance = new this.runtime.StateMachineInstance(
                  stateMachine,
                  artboard,
                );
                var inputContents = [];
        ...
        Object.defineProperty(Rive.prototype, "artboardWidth", {
          ...
          get: function () {
            ...
            return (_a = this._artboardWidth) !== null && _a !== void 0
              ? _a
              : 0;
          },
          set: function (value) {
        ...
        Object.defineProperty(Rive.prototype, "artboardHeight", {
          ...
          get: function () {
            ...
            return (_a = this._artboardHeight) !== null && _a !== void 0
              ? _a
              : 0;
          },
          set: function (value) {
        ...
        Rive.prototype.setViewModelInstance = function (viewModelInstance) {
          var _a;
          var runtimeInstance =
            viewModelInstance === null || viewModelInstance === void 0
              ? void 0
              : viewModelInstance.runtimeInstance;
          if (
            !this.artboard ||
          ...
          (_a = this._viewModelInstance) === null || _a === void 0
            ? void 0
            : _a.cleanup();
          this._viewModelInstance = viewModelInstance;
          if (this.animator.stateMachines.length > 0) {
            this.animator.stateMachines.forEach(function (stateMachine) {
              return stateMachine.instance.setViewModelInstance(
                runtimeInstance,
              );
            });
          } else {
         ...
         */
        Rive.prototype.setGlobalViewModelInstance = function (
          name,
          viewModelInstance,
        ) {
          var _a;
          ...
          if (this.animator.stateMachines.length > 0) {
            ...
            bound = this.artboard.setGlobalViewModelInstance(
              name,
              runtimeInstance,
            );
          }
          if (bound) {
            viewModelInstance.internalIncrementReferenceCount();
            (_a = this._globalViewModelInstances.get(name)) === null ||
            _a === void 0
              ? void 0
              : _a.cleanup();
        ...
        Rive.prototype.globalViewModelNames = function () {
          var _a, _b;
          return (_b =
            (_a = this.file) === null || _a === void 0
              ? void 0
              : _a.globalViewModelNames()) !== null && _b !== void 0
            ? _b
            : [];
        };
        ...
        Rive.prototype.viewModelByName = function (name) {
          var _a;
          return (_a = this.riveFile) === null || _a === void 0
            ? void 0
            : _a.viewModelByName(name);
        };
        ...
        Rive.prototype.getArtboard = function (name) {
          var _a, _b;
          return (_b =
            (_a = this.riveFile) === null || _a === void 0
              ? void 0
              : _a.getArtboard(name)) !== null && _b !== void 0
            ? _b
            : null;
        };
        Rive.prototype.getBindableArtboard = function (name) {
          ...
          return (_b =
            (_a = this.riveFile) === null || _a === void 0
              ? void 0
              : _a.getBindableArtboard(name)) !== null && _b !== void 0
            ? _b
            : null;
        };
        Rive.prototype.getDefaultBindableArtboard = function () {
          ...
          return (_b =
            (_a = this.riveFile) === null || _a === void 0
              ? void 0
              : _a.getDefaultBindableArtboard()) !== null && _b !== void 0
            ? _b
            : null;
        };
        /**
      ...
      var ViewModelInstance = /** @class */ (function () {
         ...
         * method for internal use, it shouldn't be called externally
         */
        ViewModelInstance.prototype.removeFromPropertyCallbacks = function (
          property,
        ) {
          var _this = this;
          if (this._propertiesWithCallbacks.includes(property)) {
            this._propertiesWithCallbacks =
              this._propertiesWithCallbacks.filter(function (prop) {
         ...
         * method for internal use, it shouldn't be called externally
         */
        ViewModelInstance.prototype.removeFromViewModelCallbacks = function (
          instance,
        ) {
          var _this = this;
          if (this._children.includes(instance)) {
        ...
        ViewModelInstance.prototype.viewModelFromPathSegments = function (
          pathSegments,
          index,
        ) {
          var viewModelInstance = this.internalViewModelInstance(
            pathSegments[index],
          );
        ...
        ViewModelInstance.prototype.propertyFromPathSegments = function (
          ...
          switch (type) {
            case PropertyType.Number:
              instance =
                (_b =
                  (_a = this._runtimeInstance) === null || _a === void 0
                    ? void 0
                    : _a.number(pathSegments[index])) !== null && _b !== void 0
                  ? _b
                  : null;
              if (instance !== null) {
            ...
            case PropertyType.String:
              instance =
                (_d =
                  (_c = this._runtimeInstance) === null || _c === void 0
                    ? void 0
                    : _c.string(pathSegments[index])) !== null && _d !== void 0
                  ? _d
                  : null;
              if (instance !== null) {
            ...
            case PropertyType.Boolean:
              instance =
                (_f =
                  (_e = this._runtimeInstance) === null || _e === void 0
                    ? void 0
                    : _e.boolean(pathSegments[index])) !== null && _f !== void 0
                  ? _f
                  : null;
              if (instance !== null) {
            ...
            case PropertyType.Color:
              instance =
                (_h =
                  (_g = this._runtimeInstance) === null || _g === void 0
                    ? void 0
                    : _g.color(pathSegments[index])) !== null && _h !== void 0
                  ? _h
                  : null;
              if (instance !== null) {
            ...
            case PropertyType.Trigger:
              instance =
                (_k =
                  (_j = this._runtimeInstance) === null || _j === void 0
                    ? void 0
                    : _j.trigger(pathSegments[index])) !== null && _k !== void 0
                  ? _k
                  : null;
              if (instance !== null) {
            ...
            case PropertyType.Enum:
              instance =
                (_m =
                  (_l = this._runtimeInstance) === null || _l === void 0
                    ? void 0
                    : _l.enum(pathSegments[index])) !== null && _m !== void 0
                  ? _m
                  : null;
              if (instance !== null) {
            ...
            case PropertyType.List:
              instance =
                (_p =
                  (_o = this._runtimeInstance) === null || _o === void 0
                    ? void 0
                    : _o.list(pathSegments[index])) !== null && _p !== void 0
                  ? _p
                  : null;
              if (instance !== null) {
            ...
            case PropertyType.Image:
              instance =
                (_r =
                  (_q = this._runtimeInstance) === null || _q === void 0
                    ? void 0
                    : _q.image(pathSegments[index])) !== null && _r !== void 0
                  ? _r
                  : null;
              if (instance !== null) {
            ...
            case PropertyType.Font:
              instance =
                (_t =
                  (_s = this._runtimeInstance) === null || _s === void 0
                    ? void 0
                    : _s.font(pathSegments[index])) !== null && _t !== void 0
                  ? _t
                  : null;
              if (instance !== null) {
            ...
            case PropertyType.Artboard:
              instance =
                (_v =
                  (_u = this._runtimeInstance) === null || _u === void 0
                    ? void 0
                    : _u.artboard(pathSegments[index])) !== null &&
                _v !== void 0
                  ? _v
                  : null;
              if (instance !== null) {
        ...
        ViewModelInstance.prototype.internalViewModelInstance = function (
          name,
        ) {
          var _a;
        ...
        ViewModelInstance.prototype.number = function (path) {
          var viewmodelInstanceValue = this.propertyFromPath(
            path,
            PropertyType.Number,
          );
        ...
        ViewModelInstance.prototype.internalReplaceViewModel = function (
          ...
          if (value.runtimeInstance !== null) {
            var result =
              ((_a = this._runtimeInstance) === null || _a === void 0
                ? void 0
                : _a.replaceViewModel(name, value.runtimeInstance)) || false;
            if (result) {
        ...
        Object.defineProperty(ViewModelInstance.prototype, "properties", {
          get: function () {
            ...
            return (
              ((_a = this._runtimeInstance) === null || _a === void 0
                ? void 0
                : _a.getProperties().map(function (prop) {
        ...
        Object.defineProperty(ViewModelInstance.prototype, "viewModelName", {
          ...
          get: function () {
            ...
            return (_b =
              (_a = this._runtimeInstance) === null || _a === void 0
                ? void 0
                : _a.getViewModelName()) !== null && _b !== void 0
              ? _b
              : "";
          },
          enumerable: false,
      ...
      var ViewModelInstanceValue = /** @class */ (function () {
        ...
        ViewModelInstanceValue.prototype.internalHandleCallback = function (
          callback,
        ) {};
      ...
      var ViewModelInstanceString = /** @class */ (function (_super) {
        ...
        ViewModelInstanceString.prototype.internalHandleCallback = function (
          callback,
        ) {
          callback(this.value);
        };
      ...
      var ViewModelInstanceNumber = /** @class */ (function (_super) {
        ...
        ViewModelInstanceNumber.prototype.internalHandleCallback = function (
          callback,
        ) {
          callback(this.value);
        };
      ...
      var ViewModelInstanceBoolean = /** @class */ (function (_super) {
        ...
        ViewModelInstanceBoolean.prototype.internalHandleCallback = function (
          callback,
        ) {
          callback(this.value);
        };
      ...
      var ViewModelInstanceTrigger = /** @class */ (function (_super) {
        ...
        ViewModelInstanceTrigger.prototype.internalHandleCallback = function (
          callback,
        ) {
          callback();
        };
      ...
      var ViewModelInstanceEnum = /** @class */ (function (_super) {
        ...
        ViewModelInstanceEnum.prototype.internalHandleCallback = function (
          callback,
        ) {
          callback(this.value);
        };
      ...
      var ViewModelInstanceList = /** @class */ (function (_super) {
        ...
        ViewModelInstanceList.prototype.addInstanceAt = function (
          instance,
          index,
        ) {
          if (instance.runtimeInstance != null) {
        ...
        ViewModelInstanceList.prototype.internalHandleCallback = function (
          callback,
        ) {
          callback();
        };
      ...
      var ViewModelInstanceColor = /** @class */ (function (_super) {
        ...
        ViewModelInstanceColor.prototype.internalHandleCallback = function (
          callback,
        ) {
          callback(this.value);
        };
            ...
            this._viewModelInstanceValue.value(
              (_a =
                image === null || image === void 0
                  ? void 0
                  : image.nativeImage) !== null && _a !== void 0
                ? _a
                : null,
            );
          },
      ...
      var ViewModelInstanceAssetFont = /** @class */ (function (_super) {
        ...
        Object.defineProperty(ViewModelInstanceAssetFont.prototype, "value", {
          set: function (font) {
            ...
            this._viewModelInstanceValue.value(
              (_a =
                font === null || font === void 0 ? void 0 : font.nativeFont) !==
                null && _a !== void 0
                ? _a
                : null,
            );
        ...
        ViewModelInstanceAssetFont.prototype.internalHandleCallback = function (
          callback,
        ) {
          callback();
        };
      ...
      var ViewModelInstanceArtboard = /** @class */ (function (_super) {
        ...
        Object.defineProperty(ViewModelInstanceArtboard.prototype, "value", {
          set: function (artboard) {
            ...
            if (artboard.isBindableArtboard) {
              ...
              bindableArtboard =
                artboard.file.internalBindableArtboardFromArtboard(
                  artboard.nativeArtboard,
                );
            }
            this._viewModelInstanceValue.value(
              (_a =
                bindableArtboard === null || bindableArtboard === void 0
                  ? void 0
                  : bindableArtboard.nativeArtboard) !== null && _a !== void 0
                ? _a
                : null,
            );
            if (
              bindableArtboard === null || bindableArtboard === void 0
                ? void 0
                : bindableArtboard.nativeViewModel
            ) {
              this._viewModelInstanceValue.viewModelInstance(
                (_b =
                  bindableArtboard === null || bindableArtboard === void 0
                    ? void 0
                    : bindableArtboard.nativeViewModel) !== null &&
                  _b !== void 0
                  ? _b
                  : null,
              );
        ...
        ViewModelInstanceArtboard.prototype.internalHandleCallback = function (
          callback,
        ) {
          callback();
        };
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              ...
              case 1:
                ...
                if (!res.ok) {
                  throw new Error(
                    "Failed to fetch the Rive file: HTTP ".concat(res.status),
                  );
                }
            ...
            switch (_a.label) {
              case 0:
                decodedPromise = new Promise(function (resolve) {
                  return _runtimeLoader__WEBPACK_IMPORTED_MODULE_1__.RuntimeLoader.getInstance(
                    function (rive) {
              ...
              case 1:
                audio = _a.sent();
                audioWrapper =
                  new _utils__WEBPACK_IMPORTED_MODULE_3__.AudioWrapper(audio);
                _utils__WEBPACK_IMPORTED_MODULE_3__.finalizationRegistry.register(
                  audioWrapper,
                  audio,
                );
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              ...
              case 1:
                image = _a.sent();
                imageWrapper =
                  new _utils__WEBPACK_IMPORTED_MODULE_3__.ImageWrapper(image);
                _utils__WEBPACK_IMPORTED_MODULE_3__.finalizationRegistry.register(
                  imageWrapper,
                  image,
                );
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              ...
              case 1:
                font = _a.sent();
                fontWrapper =
                  new _utils__WEBPACK_IMPORTED_MODULE_3__.FontWrapper(font);
                _utils__WEBPACK_IMPORTED_MODULE_3__.finalizationRegistry.register(
                  fontWrapper,
                  font,
                );
