...
import {
  ...
  handleGetChartData,
  handleGetJournalById,
  handleGetRecentJournals,
  handleGettingImages,
  handleUpdateJournal,
  handleRetryAIMetadata,
  handleUpdateAIStatus,
} from "./methods/journal.js";
import {
  getAudioBase64,
  getImageBase64,
  getThumbnailBase64,
...
} from "./methods/media.js";
import {
  handleAddCategory,
  handleDeleteCategory,
  handleGetCategories,
  handleUpdateCategory,
} from "./methods/categories.js";
import {
  handleCompleteGoal,
  handleCreateGoal,
  handleDeleteGoal,
  handleGetActiveGoals,
  handleGetCompletedGoals,
  handleGetGoalById,
  handleGetPinnedGoals,
  handleTogglePin,
  handleUpdateGoal,
  handleUpdateProgress,
} from "./methods/goal.js";
import {
  handleAddProgressLog,
  handleGetProgressLogs,
} from "./methods/progressLogs.js";
import {
  generateSuggestion,
...
} from "./methods/ollama.js";
import {
  startLiveTranscription,
  stopLiveTranscription,
  transcribeAudioBlob,
} from "./methods/whisper.js";
import {
  getAllTimeScores,
  getDashboardData,
  getMonthlyScores,
  getUserStats,
} from "./methods/dashboard.js";
import { modelStore } from "./store.js";
import { registerQdrantIPC } from "./methods/qdrant.js";
import { Worker } from "node:worker_threads";
import { fileURLToPath } from "node:url";
import {
  handleChangeChatTitle,
  handleDeleteChat,
  handleGetChatById,
  handleGetChats,
  handleUserMessage,
  linkMediaToMessage as handleLinkMediaToMessage,
...
export function registerIPCHandlers(runtime) {
  ...
  ipcMain.handle(
    ...
    async (event, audioFilePath, journalId) => {
      try {
