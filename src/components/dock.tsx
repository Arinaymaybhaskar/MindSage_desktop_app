...
function DockIcon({ children, className = "" }: DockIconProps) {
  return (
    <div className={`flex items-center text-gray-400 justify-center ${className}`}>
      {children}
    </div>
  );
}
  ...
  return (
    ...
    >
      <motion.div
        ...
        className={`${className} absolute bottom-2 left-1/2 transform -translate-x-1/2 flex items-end w-fit gap-4 
  rounded-2xl 
  border-border-light dark:border-border-dark 
